...
public class GoodsSpecMapperImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public int querySpecGoodsCount(Long specId) {
        return this.selectOne(
                "com.ningpai.goods.dao.GoodsSpecMapper.querySpecGoodsCount",
                specId);
    }
     ...
     */
    @Override
    public int querySpecValueCoodsCount(Long specValueId) {
        return this.selectOne(
                "com.ningpai.goods.dao.GoodsSpecMapper.querySpecValueCoodsCount",
                specValueId);
    }
