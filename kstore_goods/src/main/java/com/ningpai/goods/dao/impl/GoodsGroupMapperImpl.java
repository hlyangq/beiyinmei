...
public class GoodsGroupMapperImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public int deleteShoppingCartByFitid(Long fitId) {
        return  this.update(
                "com.ningpai.goods.dao.GoodsGroupMapper.deleteShoppingCartByFitid",
                fitId);
    }
    ...
    public int queryGroupCount(String groupId) {
        return this
                .selectOne("com.ningpai.goods.dao.GoodsGroupMapper.queryGroupCount",groupId);
    }
