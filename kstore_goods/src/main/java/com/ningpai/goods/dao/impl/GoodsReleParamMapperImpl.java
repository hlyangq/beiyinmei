...
public class GoodsReleParamMapperImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public List<GoodsReleParam> queryAllGoodsReleParamByGoodsId(@Param(value = "goodsId") Long goodsId) {
        return selectList("com.ningpai.goods.dao.GoodsReleParamMapper.queryAllGoodsReleParamByGoodsId", goodsId);
    }
}
