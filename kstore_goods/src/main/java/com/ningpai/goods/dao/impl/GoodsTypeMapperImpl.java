...
public class GoodsTypeMapperImpl extends BasicSqlSupport implements
     ...
     * @return 查询到的行数 {@link java.lang.Integer}
     */
    public int queryCountByTypeName(String typeName, String id) {
     ...
     */
    @Override
    public int queryGoodsTypeCount(Long typeId) {
        return this.selectOne("com.ningpai.goods.dao.GoodsTypeMapper.queryGoodsTypeCount", typeId);
    }
