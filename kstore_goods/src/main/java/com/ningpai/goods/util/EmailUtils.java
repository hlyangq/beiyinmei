    ...
    public int sendEmails(HttpServletRequest request, String infoEmail, GoodsProduct goodsProduct) {
        ...
        try {
            ...
            a += HTMLTAG
                    ...
                    + HTMLTAG
                    + url
                    + "/help/2.html'style='font-family:microsoft YaHei;font-size:14px;color:#555;background:url(images/help_center.png) no-repeat left center;padding-left:20px;text-decoration:none;margin-left:10px;'>帮助中心</a></td></tr></table>"
            ...
            if (null != goodsProduct.getOfollowPrice()) {
                a += "尊敬的福气商城用户，您好:</h1><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'>您好亲！您所关注的" + goodsProduct.getDisName()
                        + "地区的,商品名为：" + goodsProduct.getGoodsInfoName() + "的商品，由" + goodsProduct.getOfollowPrice() + "元,降到了" + goodsProduct.getNfollowPrice() + "元,快来选购吧!</p>";
            } else {
                a += "尊敬的福气商城用户，您好:</h1><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'>我们的" + goodsProduct.getGoodsInfoName()
                        + "商品降价啦，快来选购吧!</p>";
            }
            a += "<p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'><br/>如有任何疑问，请拔打热线：400-555-55555</p></div><div style='font:18px microsoft YaHei;color:#0054a7;height:44px;line-height:44px;text-align:center;background:#dbedff;'>感谢您使用KStore，祝您购物愉快</div><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:20px;line-height:180%;'>收到此邮件，说明您已是福气商城尊贵的会员。<br/>为确保您接受的服务信息不被当做垃圾邮件处理，请将<a href='javascript:;'style='color:#005aa0;'>test@ningpai.com</a>添加为联系人。</p><div style='font:14px tahoma,arial,\5b8b\4f53;color:#999;text-align:center;margin-top:10px;'>Copyright©2010-2014，千米网络科技有限公司   版权所有</div></div></body></html>";
    ...
    public int sendANEmails(HttpServletRequest request, GoodsProductVo goodsProductVo, String infoEmail) {
        ...
        try {
            ...
            a += HTMLTAG
                    ...
                    + url
                    + "/help/2.html'style='font-family:microsoft YaHei;font-size:14px;color:#555;background:url(images/help_center.png) no-repeat left center;padding-left:20px;text-decoration:none;margin-left:10px;'>帮助中心</a></td></tr></table>"
                    + "<div style='margin-top:10px;overflow:hidden;text-align:center'><a href='demo.ningpai.com'></a></div><div style='margin:0;padding:20px;'><h1 style='font-family:microsoft YaHei;font-size:18px;color:#333;font-weight:500;margin:0 0 10px;padding:0;'>";

                a += "尊敬的福气商城用户，您好:</h1><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'>您好亲！您所关注的商品名为：" + goodsProductVo.getGoodsInfoName() + "的商品到货了,快来选购吧!</p>";
            a += "<p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'><br/>如有任何疑问，请拔打热线：400-555-55555</p></div><div style='font:18px microsoft YaHei;color:#0054a7;height:44px;line-height:44px;text-align:center;background:#dbedff;'>感谢您使用KStore，祝您购物愉快</div><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:20px;line-height:180%;'>收到此邮件，说明您已是福气商城尊贵的会员。<br/>为确保您接受的服务信息不被当做垃圾邮件处理，请将<a href='javascript:;'style='color:#005aa0;'>test@ningpai.com</a>添加为联系人。</p><div style='font:14px tahoma,arial,\5b8b\4f53;color:#999;text-align:center;margin-top:10px;'>Copyright©2010-2014，千米网络科技有限公司   版权所有</div></div></body></html>";
            message.setContent(a, "text/html;charset=utf-8");
            // HTMLTAG + str+"'>亲爱的用户，请点击验证邮箱</a>","text/html;charset=utf-8"
            Transport.send(message);
