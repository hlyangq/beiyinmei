...
public class GoodsReleParam {
    ...
    public boolean equals(Object o) {
        ...
        GoodsReleParam that = (GoodsReleParam) o;

        if (releParamId != null ? !releParamId.equals(that.releParamId) : that.releParamId != null) return false;
        if (goodsId != null ? !goodsId.equals(that.goodsId) : that.goodsId != null) return false;
        if (paramId != null ? !paramId.equals(that.paramId) : that.paramId != null) return false;
        return paramDelflag != null ? paramDelflag.equals(that.paramDelflag) : that.paramDelflag == null;

    }

    @Override
    public int hashCode() {
        int result = releParamId != null ? releParamId.hashCode() : 0;
        result = 31 * result + (goodsId != null ? goodsId.hashCode() : 0);
        result = 31 * result + (paramId != null ? paramId.hashCode() : 0);
        result = 31 * result + (paramDelflag != null ? paramDelflag.hashCode() : 0);
        return result;
    }
}
