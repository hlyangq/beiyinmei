...
public class GoodsReleParamServiceImpl implements GoodsReleParamService {
    ...
    public List<GoodsReleParam> queryAllReleParamByGoodId(Long goodsId) {
        return goodsReleParamMapper.queryAllGoodsReleParamByGoodsId(goodsId);
    }
    ...
    public int deleReleParamByReleParamId(Long releParamId) {
        ...
        return goodsReleParamMapper.deleteByPrimaryKey(paramMap);
    }

    @Override
    public List<GoodsReleParamVo> queryAllByGoodsId(Long goodsId) {
        return goodsReleParamMapper.queryAllByGoodsId(goodsId);
    }
}
