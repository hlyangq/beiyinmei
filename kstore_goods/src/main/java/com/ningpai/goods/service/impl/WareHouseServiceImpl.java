...
public class WareHouseServiceImpl implements WareHouseService {
    ...
    public List<FollowAndCityVo> selectFollow(Long wereId, BigDecimal productPrices, Long goodsId) {
        // 执行查询方法返回结果
        return cityMapper.selectFollow(wereId, productPrices, goodsId);
    }
     ...
     *
     * @param wareId 仓库id
     * @return 仓库下没有商品可以删除 返回true  有商品不能删除 返回false
     */
    private boolean isWareCanDelete(Long wareId) {
        return houseMapper.selectWareProductNum(wareId) == 0;
    }
