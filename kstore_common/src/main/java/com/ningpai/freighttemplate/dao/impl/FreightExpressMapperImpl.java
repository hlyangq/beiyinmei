...
public class FreightExpressMapperImpl extends BasicSqlSupport implements
    ...
    public List<FreightExpress> selectTemplateExpress(Long freightTemplateId) {
        ...
        return this
                .selectList(
                        "com.kstore.web.dao.FreightExpressMapper.selectTemplateExpress",
                        freightTemplateId);
    }
    ...
    public List<FreightExpress> selectByFreightTemplateIds(
        ...
        return this
                .selectList(
                        "com.kstore.web.dao.FreightExpressMapper.selectByFreightTemplateIds",
                        freightTemplateIds);
    }
    ...
    public int insertNewFreightExpress(FreightExpress fe) {
        ...
        return this
                .insert("com.kstore.web.dao.FreightExpressMapper.insertNewFreightExpress",
                        fe);
    }
    ...
    public Long selectLastDistributionId() {
        ...
        return this
                .selectOne("com.kstore.web.dao.FreightExpressMapper.selectLastDistributionId");
    }
    ...
    public int deleteTemplateExpress(Long distributionId) {
        ...
        return this
                .update("com.kstore.web.dao.FreightExpressMapper.deleteTemplateExpress",
                        distributionId);
    }
    ...
    public FreightExpress queryDisIdByCidandTid(FreightExpress freightExpress) {
        ...
        return this
                .selectOne(
                        "com.kstore.web.dao.FreightExpressMapper.queryDisIdByCidandTid",
                        freightExpress);
    }
    ...
    public int updateByPrimaryKeySelective(FreightExpress freightExpress) {
        ...
        return this
                .update("com.kstore.web.dao.FreightExpressMapper.updateByPrimaryKeySelective",
                        freightExpress);
    }
    ...
    public int deleteFreExpByTid(Long freightTemplateId) {
        ...
        return this.update(
                "com.kstore.web.dao.FreightExpressMapper.deleteFreExpByTid",
                freightTemplateId);
    }
    ...
    public FreightExpress selectFreightExpressByDistributionId(
        ...
        FreightExpress fe = this
                .selectOne(
                        "com.kstore.web.dao.FreightExpressMapper.selectFreightExpressByDistributionId",
                        distributionId);
        if (fe != null) {
            SysLogisticsCompany sc = this
                    .selectOne(
                            "com.kstore.web.dao.SysLogisticsCompanyMapper.selectCompanyById",
                            fe.getLogComId());
