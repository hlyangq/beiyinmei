...
public class FreightExpressAllMapperImpl extends BasicSqlSupport implements
    ...
    public int insertFreightExpressAll(List<FreightExpressAll> list) {
        ...
        return this
                .insert("com.kstore.web.dao.FreightExpressAllMapper.insertFreightExpressAll",
                        list);
    }
    ...
    public int deleteTemplateExpressAll(Long distributionId) {
        ...
        return this
                .update("com.kstore.web.dao.FreightExpressAllMapper.deleteTemplateExpressAll",
                        distributionId);
    }
    ...
    public int insertSelective(FreightExpressAll freightExpressAll) {
        ...
        return this.insert(
                "com.kstore.web.dao.FreightExpressAllMapper.insertSelective",
                freightExpressAll);
    }
