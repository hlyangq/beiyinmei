...
public class FreightTemplateMapperImpl extends BasicSqlSupport implements
    ...
    public List<FreightTemplate> searchAllTemplateList(Map<String, Object> map) {
        ...
        return this
                .selectList(
                        "com.kstore.web.dao.FreightTemplateMapper.searchAllTemplateList",
                        map);
    }
    ...
    public List<FreightTemplate> selectByFreightIds(List<Long> freightIds) {
        ...
        return this.selectList(
                "com.kstore.web.dao.FreightTemplateMapper.selectByFreightIds",
                freightIds);
    }
    ...
    public FreightTemplate selectFreightTemplateById(Long freightTemplateId) {
        ...
        return this
                .selectOne(
                        "com.kstore.web.dao.FreightTemplateMapper.selectFreightTemplateById",
                        freightTemplateId);
    }
    ...
    public int insertNewFreightTemplate(FreightTemplate ft) {
        ...
        return this
                .insert("com.kstore.web.dao.FreightTemplateMapper.insertNewFreightTemplate",
                        ft);
    }
    ...
    public Long selectFreightTemplateLastId() {
        ...
        return this
                .selectOne("com.kstore.web.dao.FreightTemplateMapper.selectFreightTemplateLastId");
    }
    ...
    public int deleteFreightTemplate(Map<String, Object> map) {
        ...
        return this
                .update("com.kstore.web.dao.FreightTemplateMapper.deleteFreightTemplate",
                        map);
    }
    ...
    public int noDefaultFreightTemplate(FreightTemplate freightTemplate) {
        ...
        return this
                .update("com.kstore.web.dao.FreightTemplateMapper.noDefaultFreightTemplate",
                        freightTemplate);
    }
    ...
    public int defaultFreightTemplate(FreightTemplate freightTemplate) {
        ...
        return this
                .update("com.kstore.web.dao.FreightTemplateMapper.defaultFreightTemplate",
                        freightTemplate);
    }
    ...
    public int updateByPrimaryKeySelective(FreightTemplate freightTemplate) {
        ...
        return this
                .update("com.kstore.web.dao.FreightTemplateMapper.updateByPrimaryKeySelective",
                        freightTemplate);
    }
    ...
    public FreightTemplate selectFreightTemplateSubOrder(
        ...
        return this
                .selectOne(
                        "com.kstore.web.dao.FreightTemplateMapper.selectFreightTemplateSubOrder",
                        paramMap);
    }
    ...
    public List<FreightTemplate> queryTemplate() {
        return this
                .selectList("com.kstore.web.dao.FreightTemplateMapper.queryTemplate");
    }
