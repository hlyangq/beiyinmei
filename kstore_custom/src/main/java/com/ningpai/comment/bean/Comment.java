    ...
    *发货速度平均分
    ...
    public void setCustomerNickNameChina() {
        if (StringUtils.isNotEmpty(this.customerNickname)) {
            try {
                this.customerNickname = new String(this.customerNickname.getBytes("ISO8859-1"), ConstantUtil.UTF);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void setGoodsNameChine() {
        if (StringUtils.isNotEmpty(this.goodsName)) {
            try {
                this.goodsName = new String(this.goodsName.getBytes("ISO8859-1"), ConstantUtil.UTF);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
