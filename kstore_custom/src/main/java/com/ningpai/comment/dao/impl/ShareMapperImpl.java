...
public class ShareMapperImpl extends BasicSqlSupport implements ShareMapper {
    ...
    public Long queryThirdIdByGoodsInfoId(Long goodsId) {
        return this.selectOne("com.ningpai.comment.dao.ShareMapper.queryThirdIdByGoodsInfoId",goodsId);
    }
     ...
     */
    @Override
    public Long queryThirdIdByShareId(Long shareId) {
        return this.selectOne("com.ningpai.comment.dao.ShareMapper.queryThirdIdByShareId",shareId);
    }
