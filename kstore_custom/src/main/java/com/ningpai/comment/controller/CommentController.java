...
public class CommentController {
    ...
    public ModelAndView initCommnet(PageBean pageBean) {
        ...
        return new ModelAndView(CustomerConstantStr.COMMENTLIST, CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllComment(pageBean, null,0L));
    }
    ...
    public ModelAndView initCommnetThird(HttpServletRequest request,PageBean pageBean,String n,String l) {
        ...
        return new ModelAndView(CustomerConstantStr.THIRD_COMMENTLIST, CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllComment(pageBean, null, (Long) request.getSession().getAttribute("thirdId")))
                .addObject("storeName", (String) request.getSession().getAttribute("storeName"));
    }
     ...
     * 按条件查询评论第三方
     *
     * @param pageBean {@link com.ningpai.util.PageBean}
     * @param comment  {@link com.ningpai.comment.bean.Comment}
     * @return
     */
    ...
    public ModelAndView queryByCommentThird(HttpServletRequest request, PageBean pageBean, @Valid Comment comment, String[] attr) throws UnsupportedEncodingException, ParseException {
        ...
        try {
            resultMap.put(CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllComment(pageBean, comment,(Long) request.getSession().getAttribute("thirdId")));
            resultMap.put(CustomerConstantStr.COMMENT, comment);
            resultMap.put("attr", attr);
            // 设置跳转路径
            pageBean.setUrl("queryByComment.htm");
            return new ModelAndView(CustomerConstantStr.THIRD_COMMENTLIST).addAllObjects(resultMap).addObject("storeName", (String) request.getSession().getAttribute("storeName"));
        } finally {
            resultMap = null;
        }
    }
    ...
    public ModelAndView queryByComment(HttpServletRequest request, String publishtime, String publishtimeTo, PageBean pageBean, @Valid Comment comment, String[] attr) throws UnsupportedEncodingException, ParseException {
        ...
        try {
            ...
            resultMap.put(CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllComment(pageBean, comment,0L));
            resultMap.put(CustomerConstantStr.COMMENT, comment);
            resultMap.put("attr", attr);
            // 设置跳转路径
            pageBean.setUrl("queryByComment.htm");
    ...
    public ModelAndView initConsult(PageBean pageBean, HttpServletRequest request) {
        ...
        return new ModelAndView(CustomerConstantStr.CONSULTLIST, CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllConsult(pageBean, null,0L));
    }
    ...
    public ModelAndView initConsult(HttpServletRequest request, PageBean pageBean,String n, String l) {
        ...
        return new ModelAndView(CustomerConstantStr.THIRD_CONSULTLIST, CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllConsult(pageBean, null, (Long) request.getSession().getAttribute("thirdId")));
    }
    ...
    public ModelAndView queryByConsult(HttpServletRequest request, String publishtime, String publishtimeTo, PageBean pageBean, @Valid Comment comment, String[] attr) throws UnsupportedEncodingException, ParseException {
        ...
        return new ModelAndView(CustomerConstantStr.CONSULTLIST, CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllConsult(pageBean, comment,0L)).addObject(CustomerConstantStr.COMMENT, comment).addObject("attr", attr);
    }
    ...
    public ModelAndView queryByConsultThird(HttpServletRequest request, PageBean pageBean, @Valid Comment comment, String[] attr) throws UnsupportedEncodingException, ParseException {
        ...
        return new ModelAndView(CustomerConstantStr.THIRD_CONSULTLIST, CustomerConstantStr.PAGEBEAN, commentServiceMapper.selectAllConsult(pageBean, comment,(Long) request.getSession().getAttribute("thirdId"))).addObject(CustomerConstantStr.COMMENT, comment).addObject("attr", attr);
    }
