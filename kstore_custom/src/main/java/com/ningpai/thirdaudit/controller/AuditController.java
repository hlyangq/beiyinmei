...
public class AuditController {
    ...
    public ModelAndView setStore(HttpServletRequest request, Long setTore, String isShow, Long storeId, String isChoice) {
        auditService.setStore(setTore, isShow, storeId, isChoice);
    ...
    public Integer newupdateStore(HttpServletRequest request, Long storeId, Long businessCircle, DeduBrokeage brokeage, String cellTime, String thirdIds, String payIds,
        ...
        if (storeId != null) {
            ...
            for(int i=0 ; i<thirdIds.split(",").length;i++){
                StoreInfo storeInfos = storeCommonSerivce.selectModelPrice(Long.valueOf(thirdIds.split(",")[0]).longValue());
                customerServiceMapper.updateStatus(storeInfos.getCustomerid().intValue());
            }
        }
    ...
    public  Map<String, Object> ajaxThirdList(HttpServletRequest request, PageBean pageBean, StoreInfo storeInfo) {
        ...
        resultMap.put("address", siteAddress + mAddress);
