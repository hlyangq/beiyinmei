...
public interface StoreCommonSerivce {
    ...
    /**
     * 批量把申请品牌变成真正的品牌(加上thirdId)
     * @param applyBrandId 自定义品牌id
     * @param applyThirdId 店铺id
     * @return 结果
     */
    int applyThirdBrandToTrue(Long applyBrandId, Long applyThirdId);
     ...
     * @return 自定义品牌详情
     */
    ApplyBrand selectByApplyBrandId(Long applyBrandId);
