...
public class StoreInfoMapperImpl extends BasicSqlSupport implements StoreInfoMapper {
    ...
    public StoreInfo selectByCustomerId(Long customerId) {
        return this.selectOne("com.ningpai.thirdaudit.mapper.StoreInfoMapper.selectByCustomerId", customerId);
    }
     ...
     */
    @Override
    public int selectPageByThirdId(Long thirdId) {
        return this.selectOne("com.ningpai.thirdaudit.mapper.StoreInfoMapper.selectPageByThirdId", thirdId);
    }
}
