...
public class CouponNoMapperImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public int modifyNoStatusNew(CouponNo no) {
        return this.update("com.ningpai.web.dao.CouponNoMapper.modifyNoStatusNew",
                no);
    }
    ...
    /**
     * 根据优惠券id和customerId查询该优惠券被当前用户领取的张数
     * @param param
     * @return
     */
    @Override
    public Long queryUsedCountByCouponIdNew(Map<String, Object> param) {

        return this.selectOne(
                "com.ningpai.web.dao.CouponNoMapper.queryUsedCountByCouponIdNew",
                param);
    }
     ...
     * 查询优惠券券码
     * (non-Javadoc)
     * @see com.ningpai.coupon.dao.CouponNoMapper#selectCouponNo(java.util.Map)
     */
    @Override
    public CouponNo selectCouponNo(Map<String, Object> map) {
        return this.selectOne("com.ningpai.web.dao.CouponNoMapper.selectNoListByNo", map);
    }
    @Override
    public CouponNo selectCouponNoByCode(String code) {
        return this.selectOne("com.ningpai.web.dao.CouponNoMapper.selectCouponNoByCode", code);
    }
