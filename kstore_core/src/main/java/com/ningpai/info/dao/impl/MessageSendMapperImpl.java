...
public class MessageSendMapperImpl extends BasicSqlSupport implements MessageSendMapper {
    ...
    /**
     * 修改消息设置
     * @param message 邮件、短信bean
     * @return 修改结果
     */
    @Override
    public int updateInformSelective(MessageBean message) {
        return this.update("com.ningpai.info.dao.MessageSendMapper.updateInformSelective", message);
    }
    /*
     * 
