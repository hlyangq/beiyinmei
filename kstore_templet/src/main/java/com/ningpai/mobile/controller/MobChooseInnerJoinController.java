...
public class MobChooseInnerJoinController {
    ...
    public Map<String, Object> ajaxQueryMobProductForInnerJoin(PageBean pb, Long cid, String pname, HttpServletRequest request) {
        ...
        map.put("pb", goodsProductService.queryProductForCouponLife(pb, cateIds, null, (Long) request.getSession().getAttribute("thirdId"), null, pname, null, null, null,"1"));
        return map;
    }
    ...
    public List<MobCateBarVo> ajaxQueryMobCateBarForSite() {
        List<MobCateBarVo> m= this.mobCateBarService.selectMobCateBarForSite();
