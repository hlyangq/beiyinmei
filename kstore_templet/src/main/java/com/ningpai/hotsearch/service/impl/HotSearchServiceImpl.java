...
public class HotSearchServiceImpl implements HotSearchService {
    ...
    public int removeHotSearchById(Long hotSearchId) {
        ...
        // 通知缓存更新
        redisAdapter.delete(CacheKeyConstant.HOTSEARCH_KEY);
    ...
    public List<HotSearch> selectHotBySelectiveForSite(Long tempid,
		...
		List<HotSearch> hotSearchs = (List<HotSearch>) redisAdapter.get(CacheKeyConstant.HOTSEARCH_KEY);
        ...
        redisAdapter.put(CacheKeyConstant.HOTSEARCH_KEY, new ArrayList<>(hotSearchs));
