...
public class ShopKuaiShang implements java.io.Serializable {
     ...
     * 生效终端
     */
    private String kstEffectiveTerminal;
    ...
    public void setAppOperation(String appOperation) {
        this.appOperation = appOperation;
    }

    public String getKstEffectiveTerminal() {
        return kstEffectiveTerminal;
    }

    public void setKstEffectiveTerminal(String kstEffectiveTerminal) {
        this.kstEffectiveTerminal = kstEffectiveTerminal;
    }
