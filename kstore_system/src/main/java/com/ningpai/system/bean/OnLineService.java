...
public class OnLineService implements java.io.Serializable {
     ...
     * 生效终端
     *
     * @see #getEffectiveTerminal()
     * @see #setEffectiveTerminal(String)
     */
    private String effectiveTerminal;
    /**
     * 扩展字段1
     *
     * @see #getExpFleid1()
     ...
     * 取得：生效终端
     * 
     * @return String 生效终端 {@link OnLineService#effectiveTerminal}
     */
    public final String getEffectiveTerminal() {
        return this.effectiveTerminal;
    }

    /**
     * 设置：生效终端
     *
     * @param effectiveTerminal
     *            生效终端
     */
    public final void setEffectiveTerminal(final String effectiveTerminal) {
        this.effectiveTerminal = effectiveTerminal;
    }
