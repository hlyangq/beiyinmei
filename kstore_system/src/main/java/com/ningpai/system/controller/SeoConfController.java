...
public class SeoConfController extends BaseController {
    ...
    public ModelAndView initSeoConf(PageBean pageBean,
    ...
    public String createSitemap(SeoConf seoConf, HttpServletRequest request) {
        try {
            ...
            // newboss和kstore的前台在同一个服务器上,取得kstore前台的上一级目录
            String kstorepath = new File(path).getParent();
            // 得到kstore前台的根目录
            File fl = new File(kstorepath + "/site/sitemap.xml");
    ...
    public ModelAndView readSeoConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") final Integer deleteStatus, @RequestParam("id") final int id) {
        ModelAndView mav = new ModelAndView();
    ...
    public ModelAndView deleteSeoConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") final Integer deleteStatus,
    ...
    public ModelAndView querySeoConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") final Integer deleteStatus,
