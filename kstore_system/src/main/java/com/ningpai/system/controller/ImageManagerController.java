...
public class ImageManagerController extends BaseController {
    ...
    public final ModelAndView initImageManager(
            ...
            @RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") final Integer deleteStatus,
    ...
    public final ModelAndView queryImageManager(
            ...
            @RequestParam(value = TAG, required = false, defaultValue = "0") final Integer tag,
            final PageBean pageBean) {
        // 保存数据库查询条件
