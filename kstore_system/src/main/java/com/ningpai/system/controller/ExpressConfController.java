...
public class ExpressConfController extends BaseController {
    ...
    public ModelAndView openUpdateExpressConfPage(@RequestParam("id") Integer id) {
        ModelAndView mav = new ModelAndView();
        try {
            // 填充字典信息
            fullDictionarys(mav);
    ...
    public ModelAndView readExpressConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus, @RequestParam("id") Integer id) {
        ModelAndView mav = new ModelAndView();
        mav.addObject(DELETESTATUS, deleteStatus);
        // 判断查询配送方式设置id是否为0
        if (id == 0) {
    ...
    public ModelAndView deleteExpressConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus, @RequestParam(value = IDS) String ids,
    ...
    public ModelAndView queryExpressConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus,
