...
public class ShopConfController extends BaseController {
    ...
    public ModelAndView initShopConf(PageBean pageBean, @RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") final Integer deleteStatus,
    ...
    public ModelAndView openUpdateShopConfPage(@RequestParam("id") Integer id) {
        ModelAndView mav = new ModelAndView();
        try {
            // 填充字典信息
            fullDictionarys(mav);
    ...
    public ModelAndView readShopConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus, @RequestParam("id") Integer id) {
        ModelAndView mav = new ModelAndView();
        mav.addObject(DELETESTATUS, deleteStatus);
        // 判断查询购物设置id是否为0
        if (id == 0) {
    ...
    public ModelAndView deleteShopConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus, @RequestParam(value = IDS) String ids) {
        ModelAndView mav = new ModelAndView();
        mav.setView(new RedirectView(INIT_SHOPCONF));
        // 判断查询对象id集合字符是否有效
    ...
    public ModelAndView queryShopConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus,
