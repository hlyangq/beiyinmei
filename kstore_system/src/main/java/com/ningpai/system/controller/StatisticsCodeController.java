...
public class StatisticsCodeController {
    ...
    public ModelAndView readStatisticsCode(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0")  Integer deleteStatus, @RequestParam("id") final Integer id) {
    	if (null == deleteStatus)
    	{
    		deleteStatus = 0;
    	}
    ...
    public ModelAndView deleteStatisticsCode(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0")  Integer deleteStatus,
    ...
    public ModelAndView queryStatisticsCode(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0")  Integer deleteStatus,
