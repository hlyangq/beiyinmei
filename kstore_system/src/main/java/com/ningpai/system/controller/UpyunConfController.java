...
public class UpyunConfController extends BaseController {
    ...
    public ModelAndView openUpdateUpyunConfPage(@RequestParam("id") Integer id) {
        ModelAndView mav = new ModelAndView();
        try {
            // 填充字典信息
            fullDictionarys(mav);
    ...
    public ModelAndView readUpyunConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus, @RequestParam("id") Integer id) {
        ModelAndView mav = new ModelAndView();
    ...
    public ModelAndView deleteUpyunConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus, @RequestParam(value = IDS) String ids) {
    ...
    public ModelAndView queryUpyunConf(@RequestParam(value = DELETESTATUS, required = false, defaultValue = "0") Integer deleteStatus,
