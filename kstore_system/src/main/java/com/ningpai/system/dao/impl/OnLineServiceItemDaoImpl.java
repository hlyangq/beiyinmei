...
public class OnLineServiceItemDaoImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public OnLineServiceItem saveAndFlush(OnLineServiceItem onLineServiceItem){
        //新增成功
        if(this.insert("com.ningpai.system.dao.OnLineServiceItemDaoImpl.saveOnLineServiceItem", onLineServiceItem)>0){
            //返回新增的对象（根据最后一个id查询出最后新增的对象）
            return this.selectOne("com.ningpai.system.dao.OnLineServiceItemDaoImpl.getOnLineServiceItemById", this.selectOne("com.ningpai.system.dao.OnLineServiceItemDaoImpl.selectLastId"));
        }else{
            return null;
        }
    }
    ...
    public int deleteAll(){
        return this.delete("com.ningpai.system.dao.OnLineServiceItemDaoImpl.deleteAll");
    }

    @Override
    public int addItems(List<OnLineServiceItem> list){
        return this.insert("com.ningpai.system.dao.OnLineServiceItemDaoImpl.addItems",list);
    }
}
