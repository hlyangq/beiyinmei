...
public class DeliveryPointMapperImpl extends BasicSqlSupport implements
    ...
    public List<DeliveryPoint> selectByCityId(Long cityId){
        return this.selectList("com.ningpai.system.dao.DeliveryPointMapper.selectByCityId",cityId);
    }
    ...
    public Long deliveryCountOfCity(Long cityId){
        return this.selectOne("com.ningpai.system.dao.DeliveryPointMapper.deliveryCountOfCity",cityId);
    }
}
