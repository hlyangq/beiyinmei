...
public class HelpCenterServiceImpl implements HelpCenterService {
    ...
    public int insertHelpCenter(HelpCenter helpCenter) {
        ...
        // 通知缓存更新
        redisAdapter.delete(CacheKeyConstant.HELPCATELIST_KEY);
        redisAdapter.delete(CacheKeyConstant.ALLISFOOT_KEY);
    ...
    public List<HelpCenter> selectAllIsFoot() {
		...
		List<HelpCenter> list  = (List<HelpCenter>) redisAdapter.get(CacheKeyConstant.ALLISFOOT_KEY);
    	...
    	list = helpCenterMapper.selectAllIsFoot();
    	
    	redisAdapter.put(CacheKeyConstant.ALLISFOOT_KEY, new ArrayList<>(list));
