...
public class InformationTypeServiceImpl implements InformationTypeService {
    ...
    public void delInformation(Long infoTypeId, Long loginUserId) {
        ...
        // 查询出该栏目下所有的子孙栏目
        Set<Long> ids = getAllInformationTypeIdByParentid(infoTypeId);
    ...
    private Set<Long> getAllInformationTypeIdByParentid(Long infoTypeId) {
        ...
        List<InformationTypeVo> list = informationTypeMapper.selectByParentId(infoTypeId);
        for (InformationTypeVo informationTypeVo : list) {
            getAllIds(informationTypeVo, ids);
        }
        return ids;
    }
    ...
    private void getAllIds(InformationTypeVo informationTypeVo, Set<Long> ids) {
        ...
        if (!CollectionUtils.isEmpty(childs)) {
            for (InformationTypeVo informationTypeVo1 : childs) {
                getAllIds(informationTypeVo1, ids);
            }
        } else {
            return;
        }
