...
public class InforSubjectServcieImpl implements InforSubjectServcie {
     ...
     */
    @Override
    public PageBean selectPCSubjectByPageBean(PageBean pb, String title) {
        return selectSubjectByPageBean(pb, title, "1", null);
    }
     ...
     */
    @Override
    public PageBean selectMobileSubjectByPageBean(PageBean pb, String title) {
        return selectSubjectByPageBean(pb, title, "0", null);
    }

    /**
     * 
     * 
     * @see com.ningpai.information.service.InforSubjectServcie#selectSubjectByPageBean(com.ningpai.util.PageBean, java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public PageBean selectSubjectByPageBean(PageBean pb, String title, String terminalFlag, String isShow) {
        /** 定义一个HashMap集合 */
        Map<String, Object> map = new HashMap<String, Object>();
        try {
            map.put("title", title);
            /** 设置PageBean的行数 */
            pb.setRows(this.subjectMapper.selectCountByTitleAndTemp2AndisShow(title, terminalFlag, null));
            /** 设置开始行数 */
