...
public class InforSubjectMapperImpl extends BasicSqlSupport implements InforSubjectMapper {
     ...
     */
    @Override
    public int selectCountByTitleAndTemp2AndisShow(String title, String temp2, String isShow) {
        Map<String, Object> param = new HashMap<>();
        param.put("title", title);
        param.put("temp2", temp2);
        param.put("isShow", isShow);
        return this.selectOne("com.ningpai.information.dao.InforSubjectMapper.selectCountByTitleAndTemp2AndIsShow", param);
    }
