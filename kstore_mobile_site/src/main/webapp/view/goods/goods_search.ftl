...
<div class="goods_filter container-fluid">
    ...
    <div class="col-xs-3">
        <a val="1D" attr="${map.searchBean.sort}" class="change_sort <#if map.searchBean.sort='11D' ||map.searchBean.sort='11D' || map.searchBean.sort='1D'>cur</#if> <#if map.searchBean.sort='11D'> s_up<#elseif map.searchBean.sort='1D'> s_down</#if>" href="javascript:;">价格</a>
    </div>
    <div class="col-xs-3">
