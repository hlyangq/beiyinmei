...
public interface CustomerFollowMapper {
     ...
     * */
    int selectCUstFollowByCustIdAndProId(Map<String,Object> paramMap);
     ...
     * @return
     */
    int selectCommByGoodsId(Map<String, Object> paramMap);
     ...
     * @return
     */
    int deleteShoppingCart(Map<String, Object> paramMap);
}
