...
public class GoodsMapperImpl extends BasicSqlSupport implements GoodsMapper {
     ...
     * 根据商品id查询分类id
     * (non-Javadoc)
     * @see com.ningpai.m.goods.dao.GoodsMapper#selectByGoodsId(java.lang.Long)
     */
    @Override
    public Long selectByGoodsId(Long goodsId) {
        return this.selectOne("com.ningpaimsite.goods.dao.GoodsMapper.selectByGoodsId", goodsId);
    }
}
