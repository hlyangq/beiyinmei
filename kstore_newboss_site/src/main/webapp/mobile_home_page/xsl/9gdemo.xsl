...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="imagenav">
		<div class="app_item app_cube" style="display: block;">
			<div class="img_adv item">
				<xsl:attribute name="id">imagenav<xsl:value-of select="@id" /></xsl:attribute>
			...
			<div class="app_edit" style="width: 100%; height: 100%;">
				<div class="app_btns">
					<a href="javascript:;" class="edit" onclick="editImagesNav(this)">
						编辑
					</a>
					<a href="javascript:;" class="delete" onclick="removeImageNav(this)">
						删除
					</a>
				</div>
			</div>
	...
	<xsl:template match="img_nav_a">
		<a class="img-nav-item">
			...
			<xsl:attribute name="data-chs">
				<xsl:value-of select="@data-chs" />
			</xsl:attribute>
			<xsl:attribute name="data-chs2">
				<xsl:value-of select="@data-chs2" />
			</xsl:attribute>
