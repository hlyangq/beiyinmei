...
//结算
function doSettlement(storeId,startTime,endTime){
    var url='settleReportByStoreId.htm?storeId='+storeId+"&startTime="+startTime+"&endTime="+endTime+"&CSRFToken="+$("#token").val()
