...
<head>
    ...
    <link href="<%=basePath %>/csscss/bootstrap-select.min.css" rel="stylesheet">
    <link href="<%=basePath %>/select2.min.css" rel="stylesheet">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <li><a  href="refurbish.htm?CSRFToken=${token}">生成页面</a>
                                                            ...
                                                            <c:if test="${tempObject.tempId == 3}"><li><a target="_blank" href="<%=basePath %>images/temp/jdcheng.png">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 9}"><li><a target="_blank" href="<%=basePath %>images/temp/bangong.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 10}"><li><a target="_blank" href="<%=basePath %>images/temp/shuma.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 11}"><li><a target="_blank" href="<%=basePath %>images/temp/fuzhuang.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 12}"><li><a target="_blank" href="<%=basePath %>images/temp/jdnew.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 13}"><li><a target="_blank" href="<%=basePath %>images/temp/tianmao.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 14}"><li><a target="_blank" href="<%=basePath %>images/temp/xiaomi.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 15}"><li><a target="_blank" href="<%=basePath %>images/temp/fuzhuanglan.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 16}"><li><a target="_blank" href="<%=basePath %>images/temp/hufucaizhuang.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 17}"><li><a target="_blank" href="<%=basePath %>images/temp/chongwu.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 18}"><li><a target="_blank" href="<%=basePath %>images/temp/jiayongdianqi.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 19}"><li><a target="_blank" href="<%=basePath %>images/temp/lvyou.jpg">查看示意图</a></li></c:if>
                                                            <c:if test="${tempObject.tempId == 21}"><li><a target="_blank" href="<%=basePath %>images/temp/jdtwo.jpg">查看示意图</a></li></c:if>
                    ...
                    <%--<div class="template_list container-fluid">--%>
                        <%--<div class="row">--%>
                            <%--<c:forEach items="${map.channelList}" var="tempObject" varStatus="i">--%>
                                <%--&lt;%&ndash;<c:if test="${tempObject.usedStatus != 1}">&ndash;%&gt;--%>
                                <%--<div class="col-xs-8">--%>
                                    <%--<div class="template_item">--%>
                                        ...
                                        <%--<div class="pull-right">--%>
                                            <%--<div class="btn-group" role="group">--%>
                                                    <%--&lt;%&ndash;<c:if test="${tempObject.usedStatus == 1}">&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;<button type="button" class="btn btn-primary" disabled>当前模板</button>&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;<c:if test="${tempObject.usedStatus != 1}">&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;<button type="button" onclick="setUsedStatus('${token}',${tempObject.tempId})" class="btn btn-default">设置为当前模板</button>&ndash;%&gt;--%>
                                                    <%--&lt;%&ndash;</c:if>&ndash;%&gt;--%>
                                            <%--</div>--%>
                                        <%--</div>--%>
                                        <%--<div class="pull-left">--%>
                                            <%--<div class="btn-group">--%>
                                                ...
                                                <%--<ul class="dropdown-menu" role="menu">--%>
                                                    ...
                                                    <%--<li><a href="queryChannelByPageBean.htm?CSRFToken=${token}&tempId=${tempObject.tempId}">查看使用该模板的频道</a></li>--%>
                                                        <%--&lt;%&ndash;<li><a href="javascriptshowChannelSet:;"  onclick="showTemp('<c:if test="${basicset!=null}">${basicset.bsetAddress}</c:if>/preview/${tempObject.tempId }')">预览</a></li>&ndash;%&gt;--%>
                                                    <%--<!-- <li><a href="selectTempView.htm?tempId=${tempObject.tempId}">模板编辑</a></li> -->--%>
                                                <%--</ul>--%>
                                            <%--</div>--%>
                                        <%--</div>--%>
