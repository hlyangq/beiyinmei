...
<div class="page_top container-fluid">
    <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-6">
            <h1 class="logo"><img alt="paistore" src="${indexLogo }"></h1>
        </div>
        <div class="col-lg-20 col-md-19 col-sm-18">
            <div class="top_banner">
                <div class="ctrl_banner">
                    <div class="ctrl_nav_top pull-right">
                        <ul>
                            <li>
                                <a href="http://bbs.qianmi.com/forum-45-1.html" target="_blank">商家社区</a>
                            </li>
                            ...
                            <c:if test="${managerFlag=='1' }">
                                <li>
                                    <a href="javascript:void(0);" onclick="appMarket()">应用市场</a>
                                </li>
                            </c:if>--%>
                            <li>
                                <a class="qIcon youjian" href="orderlist.htm?menuId=89&menuParentId=1165&myselfId=947">
                                    <span>消息</span>
                                    <label class="badge">0</label>
                                </a>
                            </li>
                            <li class="user_ctrl">
                                <a href="#" style="min-width:140px;">${name }<em></em></a>
                                <div class="user_box">
                                    <ul>
                                        <c:if test="${managerFlag=='1' }">
                                            <li>
                                                <a href="<%=basePath %>initSetting.htm?menuId=1&menuParentId=1926&myselfId=2489" class="qIcon zhanghu">控制面板</a>
                                            </li>
                                       </c:if>
                                        <li>
                                            <a href="javascript:modifyPwd();" class="qIcon suoding">修改密码</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);" onclick="goOut();" class="qIcon guanji">退出</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <div class="ctrl_nav_top pull-left">
                        <ul>
                            <li>
                                <a class="qIcon home" href="index.htm"><span>桌面</span></a>
                            </li>
                            <li class="rel_sites">
                                <a href="#">产品与服务 <em></em></a>
                                <div class="site_box" style="width:200px">
                                    <ul class="web_preview" >

                                        <li class="shop_preview" >
        ...
        <div class="col-lg-20 col-md-19 col-sm-18">
          ...
          <%--     
             ...
             <%-- </ul>--%>
              ...
              <%--</div>--%>
          <%--      <p class="version" style="color: #ffffff">标准版（2.5.9-RELEASE） </p>
            </div>
