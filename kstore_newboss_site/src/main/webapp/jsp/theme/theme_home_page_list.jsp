                            ...
                            <div class="current_template">
                                ...
                                <div class="body">
                                    <div class="pre_img pull-left">
                                        <img width="180" height="240" alt="" src="<%=basePath%>images/appsite/theme/theme-1.png">
                                    </div>
                                    <div class="pre_info pull-left">
                                        <h5>潮流先锋</h5>
                                        <p><span class="text-muted">作者：</span>千米</p>
                                        <p><span class="text-muted">简介：</span>千米</p>
                                    </div>
                                    <div class="clr"></div>
                                    <div class="pre_btns">
                                        <a href="setThemeHomePage.htm?themeCode='theme-1'"
