        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="modal-article">
			  ...
			  <p>回调地址同网站地址，如http://kstore.qianmi.com/;网站地址添加好后，点击验证，把里面的代码提供给我们千米技术人员进行修改替换，替换成功后，点击验证，验证通过后可以下一步进行提交审核</p>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="modal-article">
              ...
              <p><em>3.</em>在链接输入框中输入移动端地址，如“http://kstore.qianmi.com/mobile”保存后并发布，会弹出提示框，</p>
