...
<head>
    ...
    <link href="<%=basePath%>css/amaran.min.css" rel="stylesheet">
...
<div class="container-fluid page_body">
    <div class="row">
        <jsp:include page="../page/left.jsp"></jsp:include>
        <div class="col-lg-20 col-md-19 col-sm-18 main" style="padding-left:0px;">
            <%--<jsp:include page="../page/left2.jsp"></jsp:include>--%>
            <div class="main_cont" style="overflow-y:visible;">
                <div class="app-wrap">
                    <div class="slides" id="slides">
                        <a href="javascript:;" style="background-image:url(<%=basePath%>images/slide_01.jpg) "></a>
                        <a href="javascript:;" style="background-image:url(<%=basePath%>images/slide_02.jpg) "></a>
                        <a href="javascript:;" style="background-image:url(<%=basePath%>images/slide_03.jpg) "></a>
                    </div>
                    <div class="app-container">
                        ...
                        <div class="app-content">
                            <div class="app-header">
                                <ul class="app-tabs">
                                    <li><a class="on" href="javascript:;" id="freeAppsBtn">免费应用</a></li>
                                    <li><a href="javascript:;" id="myAppsBtn">我的应用</a></li>
                                    <li class="underline"></li>
                                </ul>
                                <div class="app-search">
                                    <button type="button" name="button" onclick="loadApps()"></button>
...
<div class="app-wrap">
    <div class="dia-mask" onclick='closeAppDialog()'></div>
    <div class="app-dialog">
        ...
        <div class="dia-content">
            <div class="info-sidebar">
                <p class="dia-app-img">
                    <img src="" alt="" width="175" height="175" id="appDetailLogo">
...
<div class="amaran-wrapper bottom right"><div class="amaran-wrapper-inner"></div></div>
...
<script src="<%=basePath%>js/app/app_alert.js"></script>
...
<script src="<%=basePath%>js/app/jquery.slides.min.js"></script>
<script src="<%=basePath%>js/app/app.min.js"></script>
<script src="<%=basePath%>js/app/jquery.amaran.min.js"></script>
<script src="<%=basePath%>js/app/app.js"></script>
</body>
</html>
