      ...
      <div class="row">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
          ...
          <div class="main_cont">
            ...
            <h2 class="main_title">添加${pageNameChild}&nbsp;<small><a href="javascript:void(0)"  onclick="$('#tgou').modal('show')" style="diaplay:block; float:right; padding-right: 12px">查看帮助<i class="icon iconfont">&#xe611;</i></a></small></h2>

            <div class="common_info common_tabs mt20">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">团购促销</a></li>
            </ul>
              ...
              <!-- 单品促销选择 商品 -->
				...
				<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-1"></div>
                    <div class="col-sm-8">
                        <input type="text" name="grouponDiscount" id="grouponDiscount" maxlength="4" class="form-control required zeroOne">
                    </div>
                 </div>
                 <%--  <div class="form-group">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <table class="table table-striped table-hover table-bordered" id="productAddList">
              <thead>
              <tr>
                <th width="50"><input type="checkbox" onchange="chooseAllPro(this);" id="chooseAllPro" style="display: none"></th>
                <th width="100">商品图片</th>  
                <th width="100">商品规格</th>
                <th width="150">商品编号</th>
                <th>商品名称</th>
