...
<html lang="zh-cn">
  ...
  <body>
   ...
   <jsp:include page="../page/header.jsp"></jsp:include>
      ...
      <div class="row">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
          ...
          <div class="main_cont">
            ...
            <h2 class="main_title">${pageNameChild}&nbsp;<small><a href="javascript:void(0);" onclick="$('#helpCreateMarketTips').modal('show')" style="diaplay:block; float:right; padding-right: 12px">查看帮助<i class="icon iconfont">&#xe611;</i></a></small></h2>
              ...
              <div class="marketing container-fluid">
                ...
                <div class="row">
                                ...
                                <div class="col-xs-4">
				                    <div class="marketing_item">
				                      <a href="javascript:;">
				                        <img alt="" src="${basePath }images/marketing/7.png">
				                        <span>满赠促销</span>
				                      </a>
				                      <div class="arrow"></div>
				                    </div>
                ...
                <div class="row">
                  <div class="col-xs-24">
                                ...
                                <div class="market_intro" style="display:none;">
			                      <h4>满赠促销</h4>
			                      <p>可为商品设置满数量赠和满金额赠促销</p>
			                     <button type="button" class="btn btn-info" onclick="createMarket('MZ');">立即添加</button>
			                      <!-- <button type="button" class="btn btn-default">查看教程</button> -->
			                    </div>
                  </div>
                </div>
    ...
    <div class="modal fade" id="helpCreateMarketTips"  role="dialog">
           <div class="modal-dialog modal-lg">
               <div class="modal-content">
                   <div class="modal-header">
                       <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                       <h4 class="modal-title">创建促销操作帮助</h4>
                   </div>
                   <div class="modal-body">
                       <div class="modal-article">
                           <p><em>1.</em>折扣和包邮作为一级促销，在商品详情页显示折后价和包邮优惠，可叠加</p>
                           <img src="./images/syshelp/yx1.png" alt="">
                           <p><em>2.</em>直降、满减、满折作为二级促销，在购物车页面勾选，且不可叠加</p>
                           <img src="./images/syshelp/yx2.png" alt="">
                       </div>
                   </div>
