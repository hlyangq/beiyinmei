                                    ...
                                    <c:forEach items="${codexList }" var="codex">
                                        <c:if test="${codex.codexType=='5' }">
                                            <div class="form-group codexDiv codexDiv${codex.codexType}">
                                                ...
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-2">
                                                    <input type="text" name="fullPrice" id="fullPrice" class="form-control fullPriceNewAdd required money">
                                                </div>
                                                <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                <div class="col-sm-1"><label class="radio-inline">减</label></div>
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-2">
                                                    <input type="text" name="reducePrice" id="reducePrice" class="form-control required money">
                                                </div>
                                                <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                            </div>
                                            ...
                                            <div class="form-group addChoose addChoose${codex.codexType}" >
                                                ...
                                                <div class="col-sm-8"><label class="radio-inline" style="color:blue" onclick="addmore(this,${codex.codexType})">+添加多级促销<span style="color:red;">（最多只能添加三级）</span></label></div>
                                            </div>
                                        </c:if>
                                        ...
                                        <c:if test="${codex.codexType=='8' }">
                                            <div class="form-group codexDiv codexDiv${codex.codexType}" style="display:none;">
                                                ...
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-2">
                                                    <input type="text" name="fullPrice"   id="fullPrice0"class="form-control fullNewAdd">
                                                </div>
                                                <div class="col-sm-1"><label class="radio-inline">元</label></div>
                            ...
                            <div class="common_form common_form_lg p20">
                                ...
                                <form class="form-horizontal" action="newdoaddmarketing.htm?CSRFToken=${token}"  id="addFormTwo" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control required specstr" name="marketingName">
                                        </div>
                                        <div class="col-sm-3">
                                            <a href="javascript:;" class="cuxiaomingchen help_tips">
                                                <i class="icon iconfont">&#xe611;</i>
                                    ...
                                    <c:forEach items="${codexList }" var="codex">
                                        ...
                                        <c:if test="${codex.codexType=='5' }">
                                            <div class="form-group codexDiv codexDiv${codex.codexType}">
                                                ...
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-2">
                                                    <input type="text" name="fullPrice"  id="fullPrice" class="form-control fullPriceNew required money">
                                                </div>
                                                <div class="col-sm-1"><label class="radio-inline">元</label></div>
                                                <div class="col-sm-1"><label class="radio-inline">减</label></div>
                                                <div class="col-sm-1"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-article">
                    ...
                    <img src="<%=basePath %>/images/syshelp/mjmz.png" alt="">
...
var num=0;
    function addmore(obj,codetype){
        ...
        if(codetype==5 && length <3){
            ...
            html+= '     <input type="text" name="fullPrice" id="fullPrice'+num+'"class="form-control fullPriceNewAdd required money">';
            html+= '</div>';
            html+='<div class="col-sm-1"><label class="radio-inline">元</label></div>';
            html+= '<div class="col-sm-1"><label class="radio-inline">减</label></div>';
            html+=  '   <div class="col-sm-1"></div>';
            html+= '<div class="col-sm-2">';
            html+= '    <input type="text" name="reducePrice" id="reducePrice'+num+'" class="form-control required money">';
            html+='</div>';
            html+='<div class="col-sm-1"><label class="radio-inline">元</label></div>';
        ...
        if(codetype==8 && length <3){
            ...
            html+='<div class="col-sm-1"></div>';
            html+='<div class="col-sm-2">';
            html+= '     <input type="text" name="fullPrice"id="fullPrice'+num+'"  class="form-control fullNewAdd required money">';
            html+= '</div>';
            html+='<div class="col-sm-1"><label class="radio-inline">元</label></div>';
