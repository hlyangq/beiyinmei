                ...
                <div class="common_data p20">
                    ...
                    <c:forEach items="${pb.list}" var="report" varStatus="i">
                        ...
                        <tr>
                            ...
                            <td><fmt:formatNumber value="${report.totalOrderMoney }"  pattern="0.00"/> </td>
                            <td><fmt:formatNumber value="${report.cateRate }"  pattern="0.00"/></td>
                            <td><fmt:formatNumber value="${report.shouldBuckle }"  pattern="0.00"/></td>
                            <td><fmt:formatNumber value="${report.totalOrderPrePrice }"  pattern="0.00"/></td>
                            <td><fmt:formatNumber value="${report.totalGoodsPrePrice }"  pattern="0.00"/></td>
                            <td>
                                ${startTime}
                                    ~
                                ${endTime}
