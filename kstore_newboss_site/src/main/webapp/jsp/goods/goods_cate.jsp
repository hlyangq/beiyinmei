    ...
    <div class="row">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
            ...
            <div class="main_cont">
                ...
                <div class="data_ctrl_area">
                    <div class="data_ctrl_search pull-right"></div>
                    <div class="data_ctrl_brns pull-left">
                        <button type="button" class="btn btn-info" onclick="showesGooodcates()">
                ...
                <div class="modal_form">
                    <form role="form" class="form-horizontal" action="addGoodsCate.htm?CSRFToken=${token }" method="post" id="saveGoodsCateForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-16">
                                <input type="text" class="form-control required specstr" maxlength="16" name="catName" onblur="checkCatNameExist(this)">
                            </div>
                            <div class="col-sm-4">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-16 catSort">
                                <input type="text" class="form-control w100 required integer" name="catSort" id="catSort">
                            </div>
                            <div class="col-sm-4">
                            </div>
                        </div>
                        <div class="form-group sp">
                            ...
                            <div class="col-sm-5" id="rateContainer">
                ...
                <div class="modal_form">
                    <form role="form" class="form-horizontal" id="updateCateForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-16">
                                <input type="text" class="form-control required specstr" maxlength="16" name="catName" id="update_cate_name" onblur="checkUpdateCatNameExist(this)">
                            </div>
                            <div class="col-sm-4">
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">E店宝导入商品分类</h4>
            </div>
            <div class="modal-body">
...
<script src="<%=basePath%>js/goods/syngoodcate.js"></script>
