                ...
                <div class="common_data p20">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" onclick="location.href='queryGroupByPrimaryKey.htm?CSRFToken=${token }&groupId=${group.groupId}';">编辑</button>
            ...
            <div class="modal-body">
                <div class="modal_form">
                    ...
                    <%--<div class="form-group group_preferamountType">--%>
                        ...
                        <%--</label>--%>
                        <%--<div class="col-sm-13">--%>
                            <%--<input type="text" class="form-control required isNoInteger" name="groupPreferamount" id="group_preferamount">--%>
                        <%--</div>--%>
                        <%--<div class="col-sm-5">--%>
                        <%--</div>--%>
                    <%--</div>--%>
                ...
                <div class="modal-body">
                    <div class="modal_form">
                        ...
                        <%--<div class="form-group group_preferamountType">--%>
                            ...
                            <%--</label>--%>
                            <%--<div class="col-sm-13">--%>
                                <%--<input type="text" class="form-control required isNoInteger" name="groupPreferamount" id="update_group_preferamount">--%>
                            <%--</div>--%>
                            <%--<div class="col-sm-5">--%>
                            <%--</div>--%>
                        <%--</div>--%>
