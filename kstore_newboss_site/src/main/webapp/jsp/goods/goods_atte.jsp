                        ...
                        <td>
                          <div class="data_item">
                            <img height="60" src="${goodsAtte.product.goodsInfoImgId }"/>
                                <p title="${goodsAtte.product.goodsInfoName}"><c:if test="${fn:length(goodsAtte.product.goodsInfoName)>40}">${fn:substring(goodsAtte.product.goodsInfoName, 0, 40)}</c:if>
                                    <c:if test="${fn:length(goodsAtte.product.goodsInfoName)<=40}">${goodsAtte.product.goodsInfoName}</c:if>
                                </p>
