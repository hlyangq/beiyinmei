                ...
                <div class="common_data p20">
                    ...
                    <div class="data_ctrl_area mb20">
                        ...
                        <div class="data_ctrl_brns pull-left">
                            ...
                            <button type="button" class="btn btn-info" onclick="showesGooods()">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${map.pageBean.list }" var="goods" varStatus="sta">
                                <tr>
                                    ...
                                    <td>
                                        <div >
                                            <p title="${goods.goodsName}"><c:if test="${fn:length(goods.goodsName)>40}">${fn:substring(goods.goodsName , 0, 40)}</c:if>
                                                <c:if test="${fn:length(goods.goodsName)<=40}">${goods.goodsName}</c:if>
                                            </p>
                                        </div>
                                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">E店宝导入商品</h4>
            </div>
            <div class="modal-body">
...
<script src="<%=basePath %>/js/goods/syngood.js"></script>
<script>
    $(function(){
        $("#importForm").validate();
        /* 表单项的值点击后转换为可编辑状态 */
