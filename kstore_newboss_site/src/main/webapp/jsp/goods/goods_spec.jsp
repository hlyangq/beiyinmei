                ...
                <div class="common_data p20">
                    ...
                    <div class="data_ctrl_area mb20">
                        ...
                        <div class="data_ctrl_brns pull-left">
                            ...
                            <button type="button" class="btn btn-info" onclick="specBatcDelete('batchDeleteSpecForm','specIds')">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="javascript:;" onclick="specDel('delSpec.htm?CSRFToken=${token}&specId=${spec.specId}',${spec.specId})">删除</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
