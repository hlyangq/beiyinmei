...
<div class="page_body container-fluid">
  <div class="row">
    ...
    <input type="hidden" value="queryByParamisthird.htm?CSRFToken=${token}" id="formName"/>
        ...
        <div class="common_data p20">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                     ...
                                     <select class="form-control cate_selector"  name="status">
                                         <option value="-1" <c:if test="${searchBean.status=='-1'}">selected="selected"</c:if>>是否上架</option>
          ...
          <table class="table table-striped table-hover">
            ...
            <c:forEach items="${pb.list}" var="goods" varStatus="sta">
              ...
              <input type="hidden" name="isThird" value="1" />
              <input type="hidden"  name="oneCateId" value="${oneCateId}"/>
              <input type="hidden" name="twoCateId" value="${twoCateId}" />
