                ...
                <div class="common_data p20">
                    ...
                    <div class="data_ctrl_area mb20">
                        ...
                        <div class="data_ctrl_brns pull-left">
                            ...
                            <button type="button" class="btn btn-info" onclick="showesGooodbrands()">
                                <i class="glyphicon glyphicon-download-alt"></i> E店宝导入
                            </button>
                        </div>
                        <div class="clr"></div>
                    </div>
                        ...
                        <%--     <td>${brand.brandUrl}</td> --%>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="javascript:;" onclick="showDeleteOneConfirmAlert2('delBrand.htm?CSRFToken=${token}&brandId=${brand.brandId}&pageNo=${pb.pageNo}','确认要删除品牌${brand.brandName}吗',${brand.brandId})">删除</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="modal-body">
                <div class="modal_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-13">
                                <input type="text" class="form-control w100 required digits" name="brandSort">
                            </div>
                            <div class="col-sm-5">
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="modal_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-13">
                                <input type="text" class="form-control w100 required digits" name="brandSort" id="brandSort">
                            </div>
                            <div class="col-sm-5">
                            </div>
                        </div>
...
<!-- E店宝导入Modal -->
<div class="modal fade" id="edGoods"  role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">E店宝导入商品品牌</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1"></div>
                    <div class="col-sm-10 edGoodsTips">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="tongbu();">确定</button>
                <button type="button" class="btn btn-default" data-dismiss="modal" onclick="window.location.reload()">返回列表</button>
            </div>
        </div>
    </div>
</div>
...
<script style="text/javascript">
     ...
     */
    function showDeleteOneConfirmAlert2(deleteUrl,tips,id) {
        ...
        $.ajax({
            url: "<%=basePath%>/isbrandlinked.htm?brandIds=" + id,
            async: false,
    ...
    function showDeleteBatchConfirmAlert2(deleteFormId,name,tips) {
        ...
        // ajax 调用接口 判断商品品牌是否关联了商品
        $.ajax({
            url: "<%=basePath%>/isbrandlinked.htm?brandIds=" + chestr,
            async: false,
            success: function (data) {
                if (data == 1) {
                    result = data;
        ...
        // 1表示品牌不能删除
        if (result == 1) {
            showTipAlert('删除的品牌中有品牌已经关联了商品无法删除');
            return;
        }

        $("#modalDialogbatch").remove();
        var confirmDialog =
                '<div class="modal fade" id="modalDialogbatch" tabindex="-1" role="dialog">'+
                '    <div class="modal-dialog">'+
                '        <div class="modal-content">'+
                '            <div class="modal-header">'+
                '                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+
