            ...
            <tbody>
             <c:forEach items="${pageBean.list}" var="store" varStatus="i">
		    	...
		    	<tr class="tableListTr">
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${store.isChoice == '1'}"><span class="label label-success">是</span></c:when>
                            <c:otherwise><span class="label label-default">否</span></c:otherwise>
                        </c:choose>
                    </td>
		    		<td>${auditTime}</td>
		    		<td>${expiryTime}</td>
   ...
   <div class="modal fade" id="set_store_street"  role="dialog">
       <div class="modal-dialog modal-lg">
           <div class="modal-content">
               ...
               <form  method="post" class="save_store" onsubmit="return validateSaveStoreForm();">
                   ...
                   <div class="modal-body">
                       ...
                       <div class="form-group">
                           ...
                           <label class="radio-inline">
                               <input type="radio" id="isChoice1" value="1" class="isChoice1" name="isChoice" >是
                           </label>
                           <label class="radio-inline">
                               <input type="radio" id="isChoice2" value="0" class="isChoice2" name="isChoice" >否
                           </label>
                       </div>
            ...
            <div class="form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-15">
                  <div class="pt5">
                    <div class="tags"></div>
                      <label class="control-label">    号结算</label>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" id="punishForm" method="post">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-5"><b style="color: #ff0000;">*</b>处罚原因：</label>
                    <div class="col-sm-1"></div>
                    <div class="col-sm-14">
                      <textarea class="form-control required specstr" rows="5" name="punishReason" id="punishReason" maxlength="255"></textarea>
                    </div>
                </div>
              <div class="form-group">
                <label class="control-label col-sm-5"><b style="color: #ff0000;">*</b>处罚规则：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-6">
              ...
              <div class="form-group punishment_1" style="display: none">
                <label class="control-label col-sm-5"><b style="color: #ff0000;">*</b>扣金额：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-6">
              ...
              <div class="form-group punishment_2" style="display: none;">
                <label class="control-label col-sm-5"><b style="color: #ff0000;">*</b>开始时间：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-12">
              ...
              <div class="form-group punishment_2" style="display: none;">
                <label class="control-label col-sm-5"><b style="color: #ff0000;">*</b>结束时间：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-12">
              ...
              <div class="form-group punishment_3" style="display: none;">
                <label class="control-label col-sm-5"><b style="color: #ff0000;">*</b>关店开始时间：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-12">
              ...
              <div class="form-group punishment_3" style="display: none;">
                <label class="control-label col-sm-5"><b style="color: #ff0000;">*</b>关店结束时间：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-12">
      ...
      $(function(){
       ...
       // $('.tags').tabControl({
         // regularEx: '^[A-Z]+$',
          ...
          $("#storeStreetIsShow2").click(function(){
              $("#isChoice2").click();
          });

          $("#isChoice1").click(function () {
              if($("#storeStreetIsShow2").prop("checked")){
                  $("#isChoice2").click();
              }
          });
      }); 
