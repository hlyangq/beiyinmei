                ...
                <div class="common_data p20">
                    ...
                    <div class="data_ctrl_area mb20">
                        ...
                        <div class="data_ctrl_brns pull-left">
                            <button type="button" class="btn btn-info" onclick="showAjaxDeleteBatchConfirmAlert('batchDeleteCommentForm','parameterIds')">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${pageBean.list}" var="comment" varStatus="i">
                                ...
                                <tr>
                                    ...
                                    <td>${fn:substringBefore(comment.commentScore,".")}星</td>
                                    <%--<td>${comment.publishIp }</td>--%>
                                    <td>
                                        <c:if test="${comment.isDisplay ==0}">
                                        <span class="label label-default" id="comment_display${comment.commentId}">否</span>
                                        </c:if>
                                        <c:if test="${comment.isDisplay ==1}">
                                            <span class="label label-success" id="comment_display${comment.commentId}">是</span>
                                        </c:if>
                                    </td>
                                    <td>${publishTime }</td>
                                    <td>
