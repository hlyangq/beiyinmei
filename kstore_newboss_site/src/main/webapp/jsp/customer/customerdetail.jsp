    ...
    <div class="tab-content">
                ...
                <div class="recommend_edit">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <%--</div>--%>
                            <div class="col-sm-12">
                                <p>积分总额： <sparn id="myallpoint">${customer.infoPointSum}</sparn></p>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <p>婚姻状况：
                                    <c:if test="${customer.infoMarital==0}"> 保密 </c:if>
                                    <c:if test="${customer.infoMarital==1}"> 已婚 </c:if>
                                    <c:if test="${customer.infoMarital==2}"> 未婚 </c:if>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div role="tabpanel" class="tab-pane" id="tab6">
            ...
            <form id="searchGoodsInfo" action="" method="post">
                ...
                <input type="hidden" name="mgUserName"  value="${name}"/>
...
<script type="text/javascript">
    ...
    function checkPoint(){
        ...
        if(point==null||point==''){
            ...
            if(point > 10000){
                $("#point").after('<label  for="point" generated="true" class="error flagerror" >每次修改积分不得大于10000</label>');
                $("#point").addClass("error");
                flag=flag&false;
            }
            else{
...
//                                if(point != 0 ){
                                    ...
                                    productListHtml += "<td >" + list[i].pointDetail +"</td><td>";
                                    productListHtml += list[i].createUser==null ? list[i].customerUsername : list[i].createUser+"</td></tr>";
//                                }
                            }
    ...
    $(function () {
        ...
        $(".pointTab").click(function () {
            ...
            if (status == '1') {
                $("#myallpoint").text($("#totalpoint").text());
            }
