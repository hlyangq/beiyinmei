                ...
                <div class="common_data p20">
                    ...
                    <div class="data_ctrl_area mb20">
                        ...
                        <div class="data_ctrl_brns pull-left">
                            <button type="button" class="btn btn-info" onclick="addgift()">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-8">
                            <input name="picUrl" id="picUrl" type="hidden" value="">
                            <img id="img" src="" height="50" hidden="hidden">
                            <input type="button" id="picchoose" value="选择"/>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <a href="javascript:;" class="pro_weight_tip help_tips">
                                <i class="icon iconfont">&#xe611;</i>
                            </a>
                        </div>
                    </div>
...
<div class="modal fade" id="picEdit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb20">
                    <input style="margin-left:5px;" type="button" id="choose" value="选择" class="btn btn-info"/>
                </div>
            ...
            <div class="modal-footer">
				 <button  type="button" class="btn btn-primary" onclick="savaPic()">保存</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
//                $('#giftDesc2').val(data.giftDesc);
    ...
    $(function(){
        ...
        $('.headPortrait').popover({
            content : '积分页展示的积分商品的图片,建议jpg，jpeg，png.尺寸220*220px',
            trigger : 'hover'
        });
