                        ...
                        <c:forEach items="${pageBean.list}" var="order" varStatus="i">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <c:if test="${order.giftOrderStatus eq 2}"><span
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1"></div>
                            <div class="col-sm-10">
                                <input class="form-control required isZipCode" name="temp3" id="expressNo" >
    ...
    function openGiftOrderDetail(giftOrderId) {
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                $("#p11").html(data.provinceName+data.cityName+data.districtName+data.shoppingAddress);
