            ...
            <tr>
              <td>
                  ...
                  <div class="data_item">
                      ...
                      <p title="${lis.goodname}"><c:if
                              test="${fn:length(lis.goodname)>40}">${fn:substring(lis.goodname, 0, 40)}</c:if>
                          <c:if test="${fn:length(lis.goodname)<=40}">${lis.goodname}</c:if>
                      </p>
		         ...
		         success: function(data) {
		             ...
		             if (data!=null&&data.list!=null&&data.list.length > 0){
		                 for(var i=0;i<data.list.length;i++){
                             ...
                             htm+='<input type="hidden" name="wareid" value="'+data.list[i].wareid+'"/>';
			        	     htm+=' </tr>';
