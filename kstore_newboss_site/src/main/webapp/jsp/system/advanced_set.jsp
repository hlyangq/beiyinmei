                ...
                <div class="common_data p20">
                    ...
                    <div class="common_info order_details mt20">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#tab3" aria-controls="tab2" role="tab" data-toggle="tab">文件上传设置</a></li>
                        ...
                        <div class="tab-content">
                                            ...
                                            <div class="col-sm-6 form_item">
                                                ...
                                                <div class="form_fill">
                                                    <select class="form-control w100" id="up_pageRows">
                                                        <option <c:if test="${pageRows=='10'}">selected="selected"</c:if>>10</option>
                                                        <option <c:if test="${pageRows=='15'}">selected="selected"</c:if>>15</option>
                                                        <option <c:if test="${pageRows=='20'}">selected="selected"</c:if>>20</option>
                                                        <option <c:if test="${pageRows=='30'}">selected="selected"</c:if>>30</option>
                                                        <option <c:if test="${pageRows=='50'}">selected="selected"</c:if>>50</option>
                                                        <option <c:if test="${pageRows=='100'}">selected="selected"</c:if>>100</option>
                                                    </select>
                                                </div>
                                            </div>
                                                <div class="col-sm-3">
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab3" style="height:350px;">
                                <div class="common_form p20">
                                    <form class="form-horizontal">
