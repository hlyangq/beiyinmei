                                ...
                                <div class="box_item">
                                    ...
                                    <div class="box_edit">
                                        <a href="javascript:;" onclick="updateSms(${sms.smsId },this);"
                                           ...
                                           smsGateway="${sms.smsGateway }" isOpen="${sms.isOpen}" smsContent="${sms.smsContent}">编辑</a>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" action="updatmess.htm" method="post" id="editMessageForm">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-5"><span style="color:red;">*</span>短信内容：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <input type="text" class="form-control required" id="smsContent" name="smsContent" onfocus="removeTips($(this))">
                        </div>
                        <label class="control-label col-sm-5"><span></span></label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16 control-label" style="text-align: left">(格式：包含内容和“@”符号，其中“@”部分为短信验证码)</div>
                    </div>
                </form>
            </div>
