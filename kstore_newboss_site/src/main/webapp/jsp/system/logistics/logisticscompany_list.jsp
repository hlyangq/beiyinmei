            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" action="addLogisticsCompany.htm" id="addCompanyForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required specstr" name="name" maxlength="30">
                        </div>
                    </div>
                    <%--<div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required" name="code" maxlength="20">
                        </div>
                    </div>--%>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-4">
                            <input type="text" class="form-control required" name="kuaidi100Code" maxlength="20">
                        </div>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-10"><label class="control-label"><a href="ap.kuaidi100.doc">点击下载快递100物流公司代码文档</a></label></div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-7">公司网址：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control url" name="comUrl" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <textarea class="form-control url" rows="5" name="queryUrl" maxlength="50"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" action="updateLogisticsCompany.htm" id="editCompanyForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required specstr" name="name" id="name" maxlength="30">
                        </div>
                    </div>
                    <%--<div class="form-group">
                        <label class="control-label col-sm-7"><font color="red">*</font>物流公司代码：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required" name="code" id="code" maxlength="20">
                        </div>
                    </div>--%>
                    <div class="form-group">
                        <label class="control-label col-sm-7"><font color="red">*</font>快递100物流公司代码：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-4">
                            <input type="text" class="form-control required" name="kuaidi100Code" id="kuaidi100Code" maxlength="20">
                        </div>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-10"><label class="control-label"><a href="ap.kuaidi100.doc">点击下载快递100物流公司代码文档</a></label></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control url" name="comUrl" id="comUrl" maxlength="50">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-7">询件网址：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <textarea class="form-control url" rows="5" name="queryUrl" id="queryUrl" maxlength="50"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-7">排序：</label>
