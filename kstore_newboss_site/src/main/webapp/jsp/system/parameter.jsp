                            ...
                            <div role="tabpanel" class="tab-pane active" id="tab1">
                                <div class="common_form p20">
                                    <form class="form-horizontal" id="editParameterForm">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-6">商家登录LOGO：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-10">
                                                <a href="javascript:;" class="choose_img_btn_third" attr_id="bsetThirdLogo">
                                                    <img src="${parameter.bsetThirdLogo }" alt="" id="bsetThirdLogo_pic" style="max-width:290px;max-height:300px;">
                                                </a>
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-6">无货时前端显示商品：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-14 form_item">
                                            <span class="form_value form_value_stock" attr_id="showStock" attr_type="radio">
                                                <c:if test="${parameter.showStock=='0'}"><span class="label label-default">否</span></c:if>
                                                <c:if test="${parameter.showStock=='1'}"><span class="label label-success">是</span></c:if>
                                            </span>
                                                <div class="form_fill">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="showStock" id="show1" value="1" <c:if test="${parameter.showStock=='1'}">checked</c:if>> 是
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="showStock" id="show2" value="0" <c:if test="${parameter.showStock=='0'}">checked</c:if>> 否
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-sm-3"></div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-6">移动端首页图标：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-14">
                                                <a href="javascript:;" class="choose_img_btn" attr_id="mobileLogoImg">
                                                    <img src="${parameter.mobileLogoImg }" alt="" id="mobileLogoImg_pic" style="max-width:290px;max-height:300px;">
                                                </a>
                                            </div>
                                            <div class="col-sm-3">
                                                <a href="javascript:;" class="mobileLogoImg help_tips">
                                                    <i class="icon iconfont">&#xe611;</i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <%--<div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <a href="javascript:;" class="regImg_register help_tips">
                                                    <i class="icon iconfont">&#xe611;</i>
                                                </a>
                                            </div>
                                        </div>--%>
                                        <div class="form-group">
                                            <label class="control-label col-sm-6">注册营销前台页面图片：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-14">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <a href="javascript:;" class="regImg_third help_tips">
                                                    <i class="icon iconfont">&#xe611;</i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-6">商城用户注册协议：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-14 form_item">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-6">商家用户注册协议：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-14 form_item">
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab2">
                                <div class="common_form p20">
                                    <form class="form-horizontal" id="editParameterForm1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-14 form_item">
                                                ...
                                                <div class="form_fill">
                                                    <input type="text" id="bsetPhone" class="form-control w300" value="${parameter.bsetPhone }" clazz="required contact">
                                                </div>
                                            </div>
                                            <div class="col-sm-3"></div>
                                        </div>
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-6">后台登录框LOGO：</label>
                                            <div class="col-sm-1"></div>
