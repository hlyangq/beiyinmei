                    ...
                    <div class="common_form p20">
                        ...
                        <form class="form-horizontal" id="editParameterForm">
                            <div class="form-group">
                                ...
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span style="display: block;margin-top: 7px">每晚12点</span>
                        ...
                        <form class="form-horizontal" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-14 form_item">
                                    ...
                                    <div class="form_fill">
                                        <input type="text" id="receiptTime" onkeyup="checkDecimal(this)" onafterpaste="checkDecimal(this)" name="receiptTime" class="form-control w300" value="${systemsSet.receiptTime }" clazz="required">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                        ...
                        <form class="form-horizontal" >
                            <div class="form-group">
                                <label class="control-label col-sm-7">订单退单限制时间设置：</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value form_value_parameter" attr_flag="4">${systemsSet.limitOrderTime}&nbsp;天</span>
                                    <div class="form_fill">
                                        <input type="text" id="limitOrderTime" onkeyup="checkDecimal(this)" onafterpaste="checkDecimal(this)" name="limitOrderTime" class="form-control w300" value="${systemsSet.limitOrderTime}" clazz="required">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>

                            <div class="limit_btns popover right">
                                <div class="arrow" style="top:50%"></div>
                                <h3 class="popover-title">确定修改？</h3>
                                <div class="popover-content">
                                    <div class="text-center">
                                        <button type="button" class="btn btn-primary btn-limit-save">确定</button>
                                        &nbsp;&nbsp;
                                        <button type="button" class="btn btn-default form_cancel">取消</button>
                                    </div>
                                </div>
                        ...
                        <form class="form-horizontal" >
                            <div class="form-group">
                                <label class="control-label col-sm-7">快递100Key：</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value " attr_flag="5">${systemsSet.kuaidi100key}</span>
                                    <div class="form_fill">
                                        <input type="text" id="kuaidi100key" name="kuaidi100key" class="form-control w300" value="${systemsSet.kuaidi100key}" clazz="required">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>

                            <div class="key_btns popover right">
                                <div class="arrow" style="top:50%"></div>
                                <h3 class="popover-title">确定修改？</h3>
                                <div class="popover-content">
                                    <div class="text-center">
                                        <button type="button" class="btn btn-primary btn-key-save">确定</button>
                                        &nbsp;&nbsp;
                                        <button type="button" class="btn btn-default form_cancel">取消</button>
                                    </div>
                                </div>
