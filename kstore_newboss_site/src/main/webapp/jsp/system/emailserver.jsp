                ...
                <div class="common_data p20">
                    ...
                    <div class="common_form p20">
                        <form class="form-horizontal" id="editEmailServerForm">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-6">绑定邮箱邮件内容：</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value" attr_id="bindInfo">${map.bindInfo.informText }&nbsp;</span>
                                    <div class="form_fill">
                                        <input type="hidden" value="${map.bindInfo.informId}" >
                                        <input type="text" class="form-control w250" value="${map.bindInfo.informText }" id="bindInfo" clazz="required specstr">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <a href="javascript:;" class="bindInfoTips help_tips">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-6">验证邮箱邮件内容：</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value" attr_id="validateInfo">${map.validateInfo.informText }&nbsp;</span>
                                    <div class="form_fill">
                                        <input type="hidden" value="${map.validateInfo.informId}" >
                                        <input type="text" class="form-control w250" value="${map.validateInfo.informText }" id="validateInfo" clazz="required specstr">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <a href="javascript:;" class="validateInfoTips help_tips">
                                        <i class="icon iconfont">&#xe611;</i>
                                    </a>
                                </div>
                                <div class="col-sm-3"></div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-6">找回密码邮件内容：</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value" attr_id="findInfo">${map.findInfo.informText }&nbsp;</span>
                                    <div class="form_fill">
                                        <input type="hidden" value="${map.findInfo.informId}" >
                                        <input type="text" class="form-control w250" value="${map.findInfo.informText }" id="findInfo" clazz="required specstr">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <a href="javascript:;" class="findInfoTips help_tips">
                                        <i class="icon iconfont">&#xe611;</i>
                                    </a>
                                </div>
                                <div class="col-sm-3"></div>
