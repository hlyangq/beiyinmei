                        ...
                        <c:forEach items="${pageBean.list}" var="tempObject" varStatus="i">
                            <div class="col-sm-6">
                                <div class="box_item" style="height:124px;">
                                    <h2 style="width: 230px" title="${tempObject.mete}">
                                    <c:choose>
                                        <c:when test="${fn:length(tempObject.mete)>20}">
                                            ${fn:substring(tempObject.mete, 0, 15)}...
                                        </c:when>
                                        <c:otherwise>
                                            ${tempObject.mete}
                                        </c:otherwise>
                                    ...
                                    <p class="text-muted" title="${tempObject.meteDes}">
                                        <c:choose>
