                    ...
                    <form action="batchDelDeliveryPoint.htm" method="post" id="deleteDeliveryPointForm">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td title="${dp.address}">
                                    <c:choose>
                                        <c:when test="${fn:length(dp.address)>20}">
                                            ${fn:substring(dp.address, 0, 20)}...
                                        </c:when>
                                        <c:otherwise>
                                            ${dp.address}
                                        </c:otherwise>
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" action="createDeliveryPoint.htm" id="addDeliveryPointForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required specstr" name="name" maxlength="20">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <input type="text" class="form-control w200 required" maxlength="50" name="address" >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <input type="text" class="form-control w200 required specstr" name="linkman" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-18">
                            <select class="inline required" data-live-search="true" id="provinces" onchange="queryCityByProvinceId(this)">
                                <option>选择省份</option>
                                <option>江苏省</option>
                            </select>
                            <select class="inline required" data-live-search="true" id="cities" onchange="queryDistrictByCityId(this)">
                                <option>选择城市</option>
                                <option>南京市</option>
                            </select>
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" action="updateDeliveryPoint.htm" id="editDeliveryPointForm" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required specstr" name="name" id="name" maxlength="20">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required" maxlength="50" name="address" id="address">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-14">
                            <input type="text" class="form-control w200 required specstr" name="linkman" id="linkman" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-15">
                            <select class="inline required" data-live-search="true" id="province" onchange="editQueryCityByProvinceId(this)">
                                <option>选择省份</option>
                            </select>
                            <select class="inline required" data-live-search="true" id="city" onchange="editQueryDistrictByCityId(this)">
                                <option>选择城市</option>
                            </select>
