                ...
                <div class="common_data p20">
                    ...
                    <div class="data_ctrl_area mb20" style="margin-left:8px;">
                        ...
                        <div class="data_ctrl_brns pull-left">
                            ...
                            <button type="button" class="btn btn-info" onclick="showDeleteBatchConfirmAlert('picdelete','pids')">
                ...
                <div class="modal-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1"></div>
                            <div class="col-sm-6">
                                <p class="pt5"><input type="file" class="required" name="imgSrc" multiple="true"></p>
                            </div>
                        </div>
                    </div>
                </div>
