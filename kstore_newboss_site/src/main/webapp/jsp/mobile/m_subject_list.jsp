...
<input type="hidden" value="queryMobileInfoSubjectByPageBean.htm" id="formName">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
            ...
            <div class="main_cont">
                ...
                <div class="common_data p20">
                    ...
                    <form id="deleteFormId" action="delMobileInfoSubjectNew.htm">
...
<div class="modal fade" id="updateSpecialTopic"  role="dialog">
    <div class="modal-dialog modal-lg">
        <form class="form-horizontal" id="subSubjectForm" method="post" action="updateMobileInforSubjectNew.htm" >
...
<div class="modal fade" id="addSpecialTopic"  role="dialog">
    <div class="modal-dialog modal-lg">
        <form class="form-horizontal" id="addSubjectForm"  method="post" action="addMobileinforsubjectnew.htm" >
            <input type="hidden" name="CSRFToken"  value="${token}">
...
<script src="<%=basePath %>js/mobile/m_subject_list.js"></script>
