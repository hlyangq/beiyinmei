            ...
            <div class="common_form common_form_lg">
              ...
              >
				...
				<input type="hidden" id="parentTemp2" value="${parent.temp2 }"/>
                  ...
                  <div class="form-group" id="childChoose">
                      ...
                      <div class="col-sm-5">
                          <input type="text" class="form-control required" id="cateChooseInput"  readonly data-toggle="dropdown">
               ...
               <c:if test="${grade==3}">
                <div class="form-group">
                  <label class="control-label col-sm-5"><span class="text-danger">*</span>分类导航图片：</label>
                  <div class="col-sm-1"></div>
                  <div class="col-sm-8">
                    ...
                    <input type="hidden" class="required " name="imgSrc" id="imageSrc" value="${mobcatebar.imgSrc }"/>
                  </div>

                    <div class="col-sm-5">
                        用于手机端分类显示
                        <a href="javascript:;" class="up_pageRowsTip help_tips" data-original-title="" title="">
   ...
   <script type="text/javascript">
      ...
      $(function(){
          $('.up_pageRowsTip').popover({
              html:true,
              content : '<img src="<%=basePath%>images/mcate.png"  id="img"  height="260"/>',
              trigger : 'hover'
          });
      	//修改时判断是否是叶类目，显示相关div
  		if($("#temp3").val()==1){
					  ...
					  for (var i = 0; i < data.length; i++)
				        {
					      if(data[i].catParentId!=null){
					          ...
					          var node = {
						                id : data[i].catId, pId : data[i].catParentId, name : data[i].catName, open : false, catGrade : data[i].catGrade
						            };
						            zNodes.push(node);
					      }
	...
	{
   	    //if(treeNode.catGrade == 2 || treeNode.catGrade == 3){
