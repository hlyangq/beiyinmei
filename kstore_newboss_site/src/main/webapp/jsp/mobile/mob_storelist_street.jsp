...
<div class="container-fluid page_body">
    ...
    <form role="form" action="storeliststreetimage.htm" method="post"  id="adv_form" class="form-inline"></form>
    <div class="row">
...
<div class="modal fade" id="addSlideAd"  role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" id="subForm_Adver" method="post">
                    <input type="hidden" name="CSRFToken" value="${token}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input name="adverPath" id="adverPath" type="hidden" class="required" value="">
