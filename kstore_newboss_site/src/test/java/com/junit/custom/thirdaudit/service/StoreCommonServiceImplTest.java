 ...
 */
 public void testSelectThirdCate() {
     ...
     */
    @Test
    public void testSelectApplyBrandbyStoreId() {
        storeCommonMapperMock.returns(new ArrayList<>()).selectApplyBrand(1L);
        assertNotNull(storeCommonService.selectApplyBrandbyStoreId(1L));
    }
 ...
 */
    public void testApplyBrandToTrueBrand(){
        ...
        storeCommonMapperMock.returns(1).insertGrandBrand(tgb);
