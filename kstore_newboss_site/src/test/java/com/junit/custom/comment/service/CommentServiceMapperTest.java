...
//        customer = JSON.parseObject(customerJS,Customer.class);
    ...
    public void testSelectAllComment(){
        ...
        assertEquals(1,commentServiceMapper.selectAllComment(new PageBean(), new Comment(),0L).getList().size());
    }
    ...
    public void testSelectAllConsult(){
        Map<String, Object> paramMap= new HashMap<String, Object>();
        Comment comment = new Comment();
        commentMapperMock.returns(1L).selectAllConsultCount(0l);
        ...
        assertEquals(1,commentServiceMapper.selectAllConsult(new PageBean(), new Comment(),0L).getList().size());
    }
...
//    }
     ...
     */
    @Test
    public void testSelectCommByGoodsIdHyc() {
        PageBean pageBean = new PageBean();

        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("goodsId", 1L);
        paramMap.put("commentType", '1');
        paramMap.put("paramString", "djk");
        commentMapperMock.returns(1L).selectGoodAllCommCount(paramMap);
        commentMapperMock.returns(new ArrayList<>()).selectAllCommentByGoodsIdHyc(paramMap);
        assertEquals(0, commentServiceMapper.selectCommByGoodsIdHyc(pageBean, 1L, '1', "djk").getList().size());
    }
     ...
     */
    @Test
    public void testSelectCommDetailByGoodsIdHyc() {
        PageBean pageBean = new PageBean();
        ...
        paramMap.put("paramString", "djk");
        commentMapperMock.returns(1L).selectGoodAllCommCount(paramMap);
        commentMapperMock.returns(new ArrayList<>()).selectAllCommentDetailByGoodsId(paramMap);
        assertEquals(0, commentServiceMapper.selectCommDetailByGoodsIdHyc(pageBean, 1L, '1', "djk").getList().size());
    }
