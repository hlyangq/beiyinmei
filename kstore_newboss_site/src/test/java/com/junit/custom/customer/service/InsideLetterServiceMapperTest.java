...
public class InsideLetterServiceMapperTest extends UnitilsJUnit3{
    ...
    public void testInsertNotices(){
        ...
        assertEquals(0, insideLetterServiceMapper.insertNotices(insideLetterList.get(0), new Long[]{1L}));
    }
    ...
    public void testGetIsNotReadCount() {
        insideLetterMapperMock.returns(1L).findInsideCount(1L);
        Long result = 1L;
        assertEquals(result, insideLetterServiceMapper.getIsNotReadCount(1L));
    }
     ...
     */
    @Test
    public void testQueryInsideLetters() {
        insideLetterMapperMock.returns(new ArrayList<>()).selectListNoPage(null);
        assertNotNull(insideLetterServiceMapper.queryInsideLetters(null));
    }
}
