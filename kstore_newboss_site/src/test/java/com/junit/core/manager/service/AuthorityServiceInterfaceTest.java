...
public class AuthorityServiceInterfaceTest  extends UnitilsJUnit3 {
    ...
    @Test
    public void testQueryAuthorId() {
        authorityMapperMock.returns(new Authority()).selectByPrimaryKey(1L);
        assertNotNull(authorityServiceInterface.queryAuthorId(1L));
    }
    ...
    public void testAddAuthorityPageBatch() {
        ...
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("authorityId", 1L);
        paramMap.put("menuVos", null);
        authorityServiceInterface.addAuthorityPageBatch(1L, null);
    }
    ...
    public void testDeleteAuthByBundleName(){
        authorityServiceInterface.deleteAuthByBundleName("djk");
    }

    public void testCheckManagerExist()
    {
        authorityMapperMock.returns(new Authority()).checkManagerExist("djk");
        assertNotNull(authorityServiceInterface.checkManagerExist("djk"));
    }
    ...
    public void testMergeAuthority(){
        authorityMapperMock.returns(1).updateByPrimaryKeySelective(authorityList.get(0));
        List<Long> pages = new ArrayList<Long>(0);
        pages.add(1L);
        pageMapperMock.returns(pages).selectByPrimaryKeys(pages);
        ArrayList<Map<String, Object>> authorities = new ArrayList<Map<String, Object>>(0);
    ...
    @Test
    public void testIsAuthCanDelete() {
        String[] ids = {"1"};
        authorityMapperMock.returns(1).queryManangerAuthCount("1");
        assertEquals(1, authorityServiceInterface.isAuthCanDelete(ids));
    }
