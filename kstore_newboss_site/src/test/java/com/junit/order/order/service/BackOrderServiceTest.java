...
public class BackOrderServiceTest  extends UnitilsJUnit3
{
	...
	{
        goodsProductVo.setGoodsInfoId(2L);
	...
	//	backOrderMapperMock.returns(1).searchBackOrderThirdCount(paramMap);
        backOrderMapperMock.returns(1).searchBackOrderCountnew(paramMap);
    ...
    //    backOrderMapperMock.returns(backorders).searchBackOrderLisThird(paramMap);
        backOrderMapperMock.returns(backorders).searchBackOrderListnew(paramMap);
...
//        backOrder.setBusinessId(1L);
	...
	public void testReducePointOrderBack()
	{
        ...
        backOrder.setBackPrice(BigDecimal.TEN);
        backOrderMapperMock.returns(backOrder).selectBackOrder("111");
