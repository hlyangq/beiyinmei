...
public class ProductWareServiceTest extends UnitilsJUnit3{
    ...
    @InjectIntoByType
    Mock<GoodsService> goodsServiceMock;
    /**
     * JS数据
     * */
    ...
    public void testCalcProductWare(){
        ...
        request.getSession().setAttribute("cust", 1L);
        goodsServiceMock.returns(1).updateArrivalNotice(request,1L,1L);
        assertEquals(0, productWareService.calcProductWare(request, 5L, new Long[]{100L, 100L}, new BigDecimal[]{BigDecimal.valueOf(99.2), BigDecimal.valueOf(90.2)}, new Long[]{1L, 1L}));
    }
