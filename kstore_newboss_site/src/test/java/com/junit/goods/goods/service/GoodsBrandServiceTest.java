...
public class GoodsBrandServiceTest  extends UnitilsJUnit3 {
  ...
  public void testSelectByBrandName(){
     ...
     * 根据品牌名称查询商品品牌
     */
    public void testSelectGoodsBrandByBrandName(){
        GoodsBrand brand = new GoodsBrand();
        brand.setBrandName("111");
        goodsBrandMapperMock.returns(brand).selectGoodsBrandByBrandName("111");
        assertNotNull(goodsBrandService.selectGoodsBrandByBrandName("111"));
    }
}
