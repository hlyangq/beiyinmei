...
public class ILogisticsCompanyBizTest  extends UnitilsJUnit3
{
     ...
     */
    @Test
    public void testQueryLogisticsCompanys(){
        List<LogisticsCompany> lists = new ArrayList<>();
        lists.add(logisticsCompany);
        iLogisticsCompanyDaoMock.returns(lists).queryLogisticsCompanys();
        assertEquals(1,iLogisticsCompanyBiz.queryLogisticsCompanys().size());
    }
}
