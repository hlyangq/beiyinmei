...
public class LoginServiceTest   extends UnitilsJUnit3
{
    ...
    public void testCheckCustomerExists()
    {
    	...
    	customer.setCustomerPassword("d10530bba5adf21a27b62194399ce0fa");
    	customer.setSaltVal("1");
    	customer.setUniqueCode("1");
        ...
        customerServiceMapperMock.returns(customer).getCustomerByUsername("djk");
