 ...
 */
package com.ningpai.third.logger.service.impl;
...
import com.ningpai.third.logger.util.ExportLog;
...
public class OperateLogServiceImpl implements OperateLogService {
    private OperateLogMapper operaLogMapper;
    ...
    public PageBean selectAllOpera(PageBean pageBean, OperationLog log,
            String starTime, String endTime, Long thirdId) {
        // 设置查询参数
     ...
     */
    @Override
    public void exportExcel(HttpServletResponse response, Long days, Long thirdId) {
    ...
    public OperateLogMapper getOperaLogMapper() {
        return operaLogMapper;
    }

    @Resource(name = "operateLogMapper")
    public void setOperaLogMapper(OperateLogMapper operaLogMapper) {
