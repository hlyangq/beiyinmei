...
public class GrandBrandMapperImpl extends BasicSqlSupport implements GrandBrandMapper {
    ...
    public GoodsBrand selectByPrimaryKey(Long brandId) {
        return this.selectOne(
                "com.ningpai.third.grandbrand.dao.ThirdGrandBrandMapper.selectByPrimaryKey",
                brandId);
    }
    ...
    public int updateApplyBrandByName(String applyBrandName) {
        ...
        return this.update(
                "com.ningpai.third.grandbrand.dao.ThirdGrandBrandMapper.updateApplyBrandByName", applyBrandName);
    }
