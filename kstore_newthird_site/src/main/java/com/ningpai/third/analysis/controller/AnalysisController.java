...
public class AnalysisController {
    ...
    public ModelAndView followAnalysis(HttpServletRequest request, String n, String l, String startTime, String endTime, String isthird, Long catId, Long selectIndex,String oneSelectCategoryValue,String twoSelectCategoryValue) {
        ...
        mav.addObject("el", json.toString());
        mav.addObject("times", times.toString());
        mav.addObject("goodsList", list);
        mav.addObject(STARTTIME, searchStartTime);
        mav.addObject(STARTTIME, searchStartTime);
        mav.addObject(ENDTIME, searchEndTime);
        mav.addObject(ISTHIRD, isthird);
        mav.addObject(SELECTINDEX, selectIndexNew);
        mav.addObject("oneCategoryValue",oneSelectCategoryValue);
        mav.addObject("twoCategoryValue",twoSelectCategoryValue);
        mav.addObject("threeCategoryValue",catId);
        return mav;
