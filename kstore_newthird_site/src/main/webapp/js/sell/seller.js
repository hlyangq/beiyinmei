...
$(function(){
	...
	*/
	...
	$("#com_btn").click(function(){
        $("#com_form").find("span[class*=error]").remove();
        check();
        function check() {
            var flag = validateChkFun.formSubmit(['#companyContactTel', '#companyCapital']);
            ...
            if (!re.test(cardUrlE) && cardUrlE != null && cardUrlE != '') {
                flag = false;
                $("#cardUrlE").addClass("error");
                $("#cardUrlE").parent("div").append("<span class='tips error'>图片文件格式错误</span>");
            }
            if (!re.test(bussUrlE) && bussUrlE != null && bussUrlE != '') {
                flag = false;
                $("#bussUrlE").addClass("error");
                $("#bussUrlE").parent("div").append("<span class='tips error'>图片文件格式错误</span>");
            }
            ...
            //    flag = false;
            //    $("#companyCapital").addClass("error");
            //    $("#companyCapital").parent("div").find("span").show();
            //}
            //
            //if (companyContactTel != "" && !reg.test(companyContactTel)) {
            //    flag = false;
            //    $("#companyContactTel").addClass("error");
            //    $("#companyContactTel").parent("div").find("span").show();
            //}
	...
	$("#bank_btn").click(function(){
        $("#bank_form").find("span[class*=error]").remove();
        check();
        function check(){
            var flag = validateChkFun.formSubmit(['#bankId', '#bankCardId']);
            var regu="^.+(.gif|.jpg|.jpeg|.GIF|.JPG|.JPEG|.png)$";
            var re = new RegExp(regu);
    ...
    $("#bankId").focus(function(){
        removeClsss(this);
    });
    $("#bankCardId").focus(function(){
        removeClsss(this);
    });
    $("#companyContactTel").focus(function(){
        removeClsss(this);
    });
    $("#bussUrlE").focus(function(){
        removeClsss(this);
    });
    $("#companyCapital").focus(function(){
        removeClsss(this);
    });
    $("#cardUrlE").focus(function(){
        removeClsss(this);
    });
