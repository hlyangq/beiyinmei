...
function addProduct(pageNo,pageSize){
    ...
    $.post("queryProductForCoupon.htm?groupId=&pageNo="+pageNo+"&pageSize="+pageSize+"&brandIds="+brandId+"&productNo="+goodsInfoItemNo,function(data){
        ...
        if(list!=null&&list.length>0){
            ...
            if(data.startNo>1){
                foot+="<li><a href='javascript:void(0);' onclick='addProduct(1," + data.pageSize + ")' data-role='1'>1</a></li><li><a href='javascript:void(0);'>...</a></li>";
            }
            ...
            if(data.totalPages>data.endNo){
                foot+="<li><a href='javascript:void(0);'>...</a></li><li><a href='javascript:void(0);' onclick='addProduct("+data.totalPages+","+data.pageSize+");' data-role='"+data.totalPages+"'>"+data.totalPages+"</a></li>";
            }
            foot+="<li ";
