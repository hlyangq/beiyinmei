...
<#assign basePath=request.contextPath>
    ...
    <script type="text/javascript">
        ...
        //判断是否选中图片 给出相应的提示语句
        function shareUrls(){
            if($("input[name='imageManageIds']:checked").length <= 0){
                $('#copy_inputs').html("请选择要复制的文件");
            }else if("" == $('#copy_input').html()){
                $('#copy_inputs').html("复制失败");
            }else{
                            ...
                            <#list map.pb.list as image>
                              ...
                              <#--<#if image_index gt 0>-->
                                ...
                                <tr onclick="shareUrl('${image.imageManageUrl!''}')" style="cursor: pointer;" class="a_css">
                                    ...
                                    <td>${image_index+1}</td>
                                    <td><div class="img"><img alt="" src="${image.imageManageUrl!''}"  height="60"/></div></td>
