                    ...
                    <div class="tab-content tabCon">
                        <div role="tabpanel" class="tab-pane active" id="businessInfo">
                            <div class="cont-item">
                                ...
                                <div class="info-cont">
                                    <div class="info-item">
                                        <label class="control-label">第三方商家logo：</label>
                                        <div class="controls"><#if info.logoUrl?? &&info.logoUrl?length!=0 ><a href="${info.logoUrl!''}" style="color:#206EBC" target="_blank">[查看]</a></#if></div>
                                    </div>
                                    <div class="info-item">
                                ...
                                <div class="info-cont info-edit sto_edit">
                                    <div class="info-item">
                                        <label class="control-label">第三方商家logo：</label>
                                        <div class="controls">
                                            <form class="form-horizontal" action="uploadImg.htm" id="addForm" method="post" enctype="multipart/form-data" target="uploadFrame">
                                                <img style="display: block;" alt="" src="${info.logoUrl!''}" id="preview_image" height="30"  />
                                            <#if isSell == "2">
                                            <#else>
                                                <input type="file" style="display:inline-block;"  onchange="checkPic()" onclick="showImg()"  name="picFile" id="couponImg" />
                                            </#if>
                                            <#if isSell == "2">
                                            <#else>
                                                <a href="javascript:;" class="productsImg help_tips" style="  background: #09e;width: 16px;height: 16px;display: inline-block;border-radius: 50%;text-align: center;color: #fff;margin: 20px;line-height:18px;">
                                    ...
                                    <div class="info-cont info-configure info-edit">
                                        <form id="storeIndexForm" action="${basePath}/updateStoreIndexState.htm" mothed="post">
                                            <div class="info-item">
                                                <label class="control-label">是否启用店铺首页：</label>
                                            <#if isSell == "2">
                                            ...
                                            <div class="info-item">
                                                ...
                                                <#else>
                                                    ...
                                                    <button class="btn btn-default cancel-btn" type="button" onclick="javascript:cancelUpdate('sto')">取消</button>
                                                </#if>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="info-cont info-edit com_edit">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="controls">
                                            ...
                                            <span class="tips error" style="display: none">图片文件格式错误</span>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <label class="control-label">注册资本：</label>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" name="companyAddrDel" value="${info.companyAddrDel!''}"/>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <label class="control-label">公司紧急联系人：</label>
                            ...
                            <div class="cont-item">
                                ...
                                <div class="info-cont">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="controls" id="bankAddrNewId">
                                            <#if info.bankAddr??>
                                ...
                                <div class="info-cont info-edit">
                                    ...
                                    <div class="info-item">
                                        <label class="control-label">公司银行账号：</label>
                                        <div class="controls">
                                            <input type="text" class="form-control"  value="${info.bankCardId!''}" name="bankCardId" id="bankCardId"/>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <label class="control-label">开户行支行名称：</label>
                                    ...
                                    <div class="info-item">
                                        <label class="control-label">开户行支行联行号：</label>
                                        <div class="controls">
                                            <input type="text" class="form-control" value="${info.bankId!''}" name="bankId" id="bankId"/>
                                        </div>
                            ...
                            <div class="cont-item">
                                ...
                                <div class="info-cont">
                                    ...
                                    <div class="info-item">
                                        <div class="info-item">
                                            <label class="control-label">客服开关：</label>
                                            <div class="controls">
                                            <#if info.qqSwitch=='0'>
                                                不启用
                                            <#else>
                                ...
                                <div class="info-cont info-edit">
                                    <form id="customer_service_form" enctype="multipart/form-data" method="post" action="third/updateseller.htm">
                                        <input name="storeId" value="${info.storeId}" type="hidden">
                                        <input name="qqSwitch" value="" type="hidden" id="qqSwitch">
                                    <div class="info-item">
                                        <label class="control-label">QQ：</label>
                                        <div class="controls">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="controls radio radio-primary" style="margin-top:0;">
                                            <label class="choose-label">
                                                <input name="qq"
                                                       <#if !(info.qqSwitch)??>checked="checked"</#if>
                                                       <#if info.qqSwitch?? && info.qqSwitch=='0'>checked="checked"</#if> value="0" type="radio"/>不启用</label>
                                            <label class="choose-label">
                                                <input name="qq"
                                                       <#if info.qqSwitch?? && info.qqSwitch=='1'>checked="checked"</#if> value="1" type="radio"/>启用</label>
                                        </div>
                                    </div>
                                    <div class="info-item">
                                        <div class="controls">
                        ...
                        <div role="tabpanel" class="tab-pane" id="shopInfo" style="display: none">
                            <div class="cont-item">
                                <div class="title">
                                    <h3>店铺基本信息</h3>
                                </div>
                            ...
                            <script>
                                ...
                                function submitUpdate(){
                                    ...
                                    if ($("#picerror").hasClass("error"))
                                    {
                                        return ;
                                    }

                                    var logo =  $("#preview_image").attr("src");

                                    var isStoreIndex = $("input[name='isStoreIndex']:checked").val() ;
                                    $.ajax({
                                        url: "${basePath}/updateStoreIndexStateAlax.htm",
                                        type:"POST",
                                        data:{isStoreIndex:isStoreIndex,logourl:logo},
                                        success: function(data){
                                            if(data==1){
                                                window.location.href = "${basePath}/sellerinfo.html";
                                            }else{
...
<script type="text/javascript">
    ...
    $(function(){
         ...
         *
         * */
        $("input[name='bankAddr']").val($("#bankAddrNewId").text());
