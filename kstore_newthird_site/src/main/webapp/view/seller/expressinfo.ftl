            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-item">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control expname_addexpress" value=""  name="expName" maxlength="15"/>
                            <label class="si_word"></label>
                            <label class="expname_Tip"></label>
                        </div>
                    </div>
                    <!--
                    <div class="form-item">
                    ...
                    <div class="form-item">
                        ...
                        <div class="controls">
                            ...
                            <label><a class="text-primary" href="ap.kuaidi100.doc">快递100物流公司代码文档</a></label>
                        </div>
                    </div>
                    <div class="form-item">
    ...
    <form method='post' action="${basePath}/third/updatedoneexpress.htm" id="expform_updates" >
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="oldExpName"/>
                    ...
                    <div class="form-item">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control expcompany_updatexpress"
                               onkeyup="this.value=this.value.replace(/[^\d]/g,'') "
                               onafterpaste="this.value=this.value.replace(/[^\d]/g,'') "
                               value="" name="expCompany" maxlength="15"/>
                            <label class="si_word"></label>
                            <label class="expcompany_Tip"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        <label class="control-label"><b>*</b>快递100：</label>
                        <div class="controls">
                            <input type="text" class="form-control kuaidi_updatexpress" id="kuaidi_updatexpress" value="" name="kudi100code" id="expkuaidi" maxlength="15"/>
                            <label class="expkuaidi"></label>
