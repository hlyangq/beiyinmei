            ...
            <div class="app-content">
                <div class="cfg-content">
                    <div class="bg-warning tips-word mb20">
                        ...
                        <span class="ml10">已使用<b class="text-danger"><#if (pb.list?size!=0)>${pb.rows}<#else>0</#if></b></span>
                        <span class="ml10">剩余<b class="text-danger"><#if (pb.list?size!=0)>${50-pb.rows}<#else>50</#if></b></span>
                    </div>
                    <div class="ops-bar">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-item">
                    ...
                    <div class="controls">
                        <input type="text" maxlength="20" onkeydown="clearErrorTip(this)" name="customerUsername" id="customerUsername" class="form-control"/>
                ...
                <div class="form-item">
                    ...
                    <div class="controls">
                        <input type="password" name="customerPassword" onkeydown="clearErrorTip(this)" id="password" class="form-control"/>
                        <label style="color:red;"></label>
                    </div>
                </div>
                <div class="form-item">
                    ...
                    <div class="controls">
                        <input type="password" name="repassword" onkeydown="clearErrorTip(this)" id="repassword" class="form-control"/>
                        <label style="color:red;"></label>
                    </div>
                </div>
                <div class="form-item">
                    ...
                    <div class="controls">
                        <input type="text" name="infoRealname" onkeydown="clearErrorTip(this)" id="realname" class="form-control"
                        <#-- 禁止录入特殊字符-->
                ...
                <div class="form-item">
                    <label class="control-label"><b>*</b>职位：</label>
                    <div class="controls checkWp authlist radio radio-primary">
                        ...
                        <label class="tips error-tip clearEmployeeTip" style="color:red;"></label>
                    </div>
                </div>
                <!--<div class="form-item">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-item error">
                    <label class="control-label opearte-info-title" style="width:130px;">请至少选择一行！</label>
                </div>
            </div>
...
<#--添加提示-->
<div class="modal fade" id="add-tip" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-item error">
                    <label class="operate-tip-title">请先添加职位！</label>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    loadauth();
    function shows(){
        if($("select[name='authorityId'] option").size() > 0 ){
