                                        ...
                                        <div class="switch-item" id="goods01">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls col-xs-3">
                                                    <input type="text" class="form-control zeroOne required" name="discountInfo" placeholder="如:打75折输入0.75"  id="allgoodsdiscount"/>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <tr>
                                                    <td class="discount-td" colspan="7">
                                                        <div class="discount-wp">
                                                            ...
                                                            <div class="helpDot">
                                                                <a href="javascript:;" class="help-notes" data-toggle="tooltip" data-placement="right" title="请输入0~1之间的小数">?</a>
                                                            </div>
                                                        </div>
