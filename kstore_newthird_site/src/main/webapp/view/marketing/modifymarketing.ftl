            ...
            <div class="app-content">
                <div class="form-container">
                       ...
                       <form class="form-horizontal" action="newsavemarketing.htm" id="addForm" method="post">
                         ...
                         <input type="hidden" name="addForm"  value="${(marketing.marketingId)!''}">
                            ...
                            <div class="form-group switch-wp">
                                ...
                                <div class="controls col-xs-8">
	                                ...
	                                <div class="switch-box mold-switch">
	                                    <p class="switch-item" id="mold01" <#if marketing.codexType=='1'>style="display: block;"</#if>>单品直减<input class="form-control input-xs text-center <#if marketing.codexType=='1'>required</#if> isNumber" type="text" name="offValue" value="${(marketing.priceOffMarketing.offValue)!''}" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"/>元
                                            &nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-group switch-wp">
                                ...
                                <div class="controls col-xs-10">
                                	<div class="radio radio-primary">
	                                    ...
	                                    <label><input name="goods" type="radio" data-switch="goods04" <#if (marketing.isAll)?? && marketing.isAll=='0' && kulist??>checked="checked"</#if> id="somegoods"/>部分参与商品</label>
                                                ...
                                                <tr>
                                                    <td class="discount-td" colspan="7">
                                                        <div class="discount-wp">
                                                            	批量折扣<input class="xs-input zeroOne" type="text" onblur="plzhekou(this)" value=""/>
                                                            <div class="helpDot">
...
<#--<div class="modal fade" id="addPromotions" role="dialog" aria-hidden="true">-->
  <#--<form role="form" class="form-horizontal" enctype="multipart/form-data" action="addthirdlogo.htm" method="post" id="saveLogoForm">-->
   ...
   <#--</form>-->
<#--</div>-->
<input type="hidden" id="alldiscount" value="${discount}"/>
...
<script>
   $(function(){
     ...
     $(".codexchoose").change(function(){
       ...
       if($("input[name='marketingFlag']").val() == 'ZK'){
           $("#goods01").append("<div class='form-group'>"+
               "<label class='control-label col-xs-2'>折扣：</label>"+
               "<div class='controls col-xs-3'>"+
               "<input type='text' class='form-control zeroOne ' id='allgoodsdiscount' onblur='plzhekou(this)'/>"+
               "<input type='hidden' value='"+$('#alldiscount').val()+"'/></div></div>")
           if($("#isAlls").val() == 1){
               $("#goods01").attr("style","display:block;");
               $("#allgoodsdiscount").val($("#allgoodsdiscount").next().val());
           }else{
               $("#goods01").attr("style","display:none;");
               $("#allgoodsdiscount").val(0);
               $("#allgoodsdiscount").removeClass("zeroOne");
           }
       }
  ...
  function subForm(){
      ...
      if(offValue < 0 ){
          ...
          if(!$("#allgoods").prop('checked')){
             ...
             $("#addForm").append("<input type='hidden' name='discountPrice' value='"+$("#allgoodsdiscount").next().val()+"'/>")
             $("#isAlls").val(1);
             $("#status").val(0);
