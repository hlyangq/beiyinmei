                            		  ...
                            		  <div class="switch-item" id="mold05">
                                            <ul class="mold-list">
                                                <li>
                                                   	 满
                                                        <span>
                                                            <input class="form-control input-xs text-center isNumber fullReduce" name="fullPrice" type="text" onfocus="updateClass($(this))"/>                                                    <label class="offValueTip error" style="color:#b94a48; display:none;">请输入金额！</label>
                                                            <label class="fullPrice error" style="color:#b94a48; display:none;">请输入金额！</label>
                                                        </span>
                                                    元，减
                                                        <span>
                                                            <input class="form-control input-xs text-center isNumber fullReduce" name="reducePrice" id="reducePrice" type="text" onfocus="updateClass($(this))"/>
                                                            <label class="reducePrice error" style="color:#b94a48; display:none;">请输入金额！</label>
                                                        </span>
                                                    元
                                        ...
                                        <div class="switch-item" id="mold08">
                                            <ul class="mold-list">
                                                <li>
                                                  	  满<span><input class="form-control input-xs text-center isNumber fullDiscount" type="text" id="fullPricemj" name="fullPrice"/></span>元，打<span><input class="form-control input-xs text-center zeroOne" name="fullbuyDiscount" type="text"/></span>折
...
//保存商品促销
   var num=0;
  function subForm(){
          $("label.fullPrice-error").remove();
          $('.fullPrice').css("display","none");
          $('.reducePrice').css("display","none");
          // 满  减
          var $fullPriceInputs;
          var $reducePrices;

          if ($("input[name='codexId']").val() === "5"){
              $fullPriceInputs = $('input.fullReduce[name="fullPrice"]');
              $reducePrices =  $('input.fullReduce[name="reducePrice"]');
          } else {
              $fullPriceInputs = $('input.fullDiscount[name="fullPrice"]');
          }
          // 判断是否小于0
         for (var i = 0; i < $fullPriceInputs.length; i++){
             var $this = $($fullPriceInputs[i]);
             var val = $this.val();
             if (val <= 0) {
                 $this.addClass("error");
      ...
      if ($reducePrices) {
          for (var i = 0; i < $reducePrices.length; i++){
              var $this = $($reducePrices[i]);
              var val = $this.val();
              if (val <= 0) {
                  $this.addClass("error");
                  $this.after('<label class="fullPrice-error" style="display: block;color:#a94442;">金额不能小于0！</label>') ;
                  console.log("return false reduce price...");
                  return false;
              }
          }
      }
          ...
          for (var i = 0; i < $fullPriceInputs.length; i++){
              ...
              if (hash[fVal]){
                  $($this).addClass("error");
                  $($this).parent().parent().append('<label class="fullPrice-error" style="display: block;color:#a94442;">满足条件价格不能重复！</label>') ;
                  return false;
              } else {
                  hash[fVal] = true;
              }
