                                ...
                                <div class="controls col-xs-8" style="line-height:34px;">
                                    ...
                                    <div class="switch-box mold-switch">
                                        <p class="switch-item" id="mold01" style="display:block">
                                            单品直减
                                            <input class="form-control input-xs isNumber text-center" type="text" name="offValue"  onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"/>元
                                            &nbsp;&nbsp;&nbsp;
  ...
  function subForm(){
      ...
      for(var i=0;i<goodsPrices.length;i++){
          ...
          if(Number(offValue) >= Number(pff_price)){
              $(".offValueTip").html("直降的金额不能大于等于促销商品的价格！");
              $('.offValueTip').css("display","block");
              return;
          }
      }
