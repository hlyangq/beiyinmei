		                            ...
		                            <tbody>
		                            	<#list pb.list as lis>
				                            <tr>
				                                ...
				                                <td>${lis.number!'' }</td>
				                                <td>${lis.stock!''}</td>
				                                <td>&yen;<#if lis.salprice??>${lis.salprice}<#else>0.00</#if></td>
				                                <td><button class="btn btn-primary btn-sm" type="button" onclick="selectstock(${lis.infoid },'${lis.goodname!'' }',${lis.stock!0 },'${lis.number!0 }'
						                        	,'¥${lis.salprice!0}','¥${lis.buyprice!0}');" data-toggle="modal" data-target="#modifyGd">修改</button></td>
			                            	</tr>
		                            	</#list>
	                            	</tbody>
	                           </form>
