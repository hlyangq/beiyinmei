...
<div class="wp">
    ...
    <input type="hidden" value="${onOffFlag!''}" id="onOffFlag"/>
                    ...
                    <div class="form-horizontal">
                        ...
                        <form class="form-horizontal" id="goods_info_form" action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                    <input type="text" name="goodsNameTemp"
                                           ...
                                           maxlength="120" minlength="3" value="<#--${importGoods.goodsName }-->"
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                        <textarea name="desInputTemp" class="form-control des_input" rows="2" maxlength="240"
                                                  onblur="$('.des_input').text($(this).val())"><#--${importGoods.goodsSubtitle }--></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-xs-2">京东详细：</label>
                                <div class="controls col-xs-8">
                                    <input type="text" class="form-control httpUrl" value=""/>
                                    <button class="btn btn-primary" type="button" onclick="loadJdDetails(this)">加载</button>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                    <input type="text" name="proPriceTemp"
                                           class="form-control sm-input pro_price required money"
                                           onblur="changeAllPrice(this);"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-2">成本价格：</label>

                                <div class="controls col-xs-8">
                                    <input name="proCostPriceTemp" type="text"
                                           class="form-control sm-input pro_cost_price money"
                                           onblur="$('.pro_cost_price').val($(this).val())"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-2">市场价格：</label>

                                <div class="controls col-xs-8">
                                    <input type="text" name="proMarkPriceTemp"
                                           class="form-control sm-input pro_mark_price money"
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                    <input type="text" name="proStock"
                                           class="form-control sm-input pro_stock required digits"
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-2"><b></b>商品参数：</label>
                                    ...
                                    <form class="form-horizontal" method="post">
                                        <div>
                                            ...
                                            <div class="form-group" style="display: block;">
                                                <label class="control-label col-xs-3">商品条形码：</label>

                                                <div class="col-xs-6">
                                                    <div class="input-group w200">
                                                        <input type="text" class="form-control isNumber barcode_input " maxlength="32" value="<#--${importGoods.goodsPrice }-->">
                                                    </div>
                                                </div>
                                                <div class="col-xs-3">
                                            ...
                                            <div class="form-group" style="display: block;">
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="input-group w200">
                                                        <input type="text" class="form-control required number goodsPrice pro_price" value="<#--${importGoods.goodsPrice }-->">
                                                    </div>
                                                </div>
                                                <div class="col-xs-3">
                                            ...
                                            <div class="form-group" style="display: none;">
                                                ...
                                                <div class="controls col-xs-7">
                                                    <div class="input-group w200">
                                                        ...
                                                        <input type="text"
                                                               class="form-control pro_cost_price"
                                            ...
                                            <div class="form-group" style="display: none;">
                                                ...
                                                <div class="col-xs-7">
                                                    <div class="input-group w200">
                                                        <span class="input-group-addon">￥</span>
                                                        <input type="text"
                                                               class="form-control pro_mark_price"
