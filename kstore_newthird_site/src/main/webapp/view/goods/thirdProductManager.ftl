...
<div class="wp">
    ...
    <div class="app-container">
        ...
        <div class="group_wp">
            <form class="search_product_form" action="thirdProductManager.htm" method="post">
            ...
            <div class="cfg-content">
                        ...
                        <tbody>
                            <#list map.pb.list as product>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p title="<#list product.specVo  as spec>${spec.spec.specName }:<#if spec.specValueRemark??><#if spec.specValueRemark == ''>${spec.goodsSpecDetail.specDetailName }<#else>${spec.specValueRemark }</#if> <#else>${spec.goodsSpecDetail.specDetailName }</#if>  &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</#list>">
                                            <#list product.specVo  as spec>
                                                <#if spec_index < 3 >
                                                ${spec.spec.specName }
                                                    :<#if spec.specValueRemark??><#if spec.specValueRemark == ''>${spec.goodsSpecDetail.specDetailName }<#else>${spec.specValueRemark }</#if> <#else>${spec.goodsSpecDetail.specDetailName }</#if>
                                                    <br/>
                                                </#if>
                                            </#list>
                                        </p>
                ...
                <#else >
                    <div class="ops-left">
                        <button class="btn btn-primary btn-xs batch_upload_product" type="button">批量上架</button>
                    </div>
                </#if>
                <#if (map.pb.list?size) &gt; 0 >
                    <div class="ops-right">
            ...
            <div class="form-container">
                <form class="sub_product form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3">货品条形码：</label>

                            <div class="controls col-xs-7">
                                <input type="text" class="form-control goodsInfoBarcode"
                                       name="goodsInfoBarcode"/>
                                <label class="goodsInfoBarcode_tip"></label>
                            </div>
                        </div>
                            ...
                            <div class="controls col-xs-7">
                                ...
                                <#if map.allProductSuppList ?? && map.allProductSuppList?size &gt; 0>
                                    <#list map.allProductSuppList as allsupp>
                                        ...
                                        <label class="choose-label"><input class="pro_supp suppchecked" type="checkbox"
                                                                           value="${allsupp.id }"
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3">成本价：</label>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3">市场价：</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-xs-7 radio radio-primary">
                                ...
                                <label class="choose-label"><input class="unshow_list" type="radio" value="0"
                                                                   name="showList"
                                                                   checked="checked"/>否</label>
                            </div>
                        </div>
                        ...
                        <#list map.specs as spec>
                            ...
                            <div class="controls col-xs-7">
                                ...
                                <input type="hidden" name="specRemark" class="up_remark myup_remark_${spec.spec.specId}"
                                       value="">
                                <select onChange="selProductParam('spec_param_Tips${spec.spec.specId}');"
                                        id="sel_specDetailId" spec_id="${spec.spec.specId}" name="specDetailId"
                                        class="tb_select sel${spec.spec.specId} form-control up_sel_spec">
                ...
                <input type="hidden" value="1" class="flagName">
            </div>
        </div>
        <input type="hidden" value="0" class="flagS">
        ...
        <div class="modi_img mt10 none">
            <form class="modi_third_product_img" enctype="multipart/form-data" action="updateThirdProductImage.htm"
                ...
                <div class="app-content" id="modi_image">
                    ...
                    <input name="goodsAddedSta" type="hidden" value="${map.goodsAddedSta}"/>
...
<script>
    ...
    function del(id) {
        ...
        $.ajax({
            url: 'checkDeleteByGoodsInfoIds.htm?CSRFToken=b184be13-7912-4b64-a2ee-bc0598ce05a8',
    ...
    function callSaveProductImageBath(urls, width, height, currentIndex, allSize, origurl) {
        ...
        if (currentIndex == allSize - 1) {
            ...
            if (errorIds.length == 0) {
                var batch_image = '';
                if (Object.prototype.toString.call(origurl) === '[object Array]') {//如果是数组(图片库上传)
                    batch_image = origurl.join(",");
                    origurl = batch_image;
                } else {//如果是字符串(本地上传)
                    origurl = origurl;
                }
                $.ajax({
                    url: '${basePath}/batchSaveProductImage.htm?productId=' + $(".img_productId_hide").val() + '&image=' + origurl,
                    success: function (data) {
                        if (data == "1") {
                ...
                if (errorIds.length == urls.length) {
                    ...
                    $.ajax({
                        url: '${basePath}/batchSaveProductImage.htm?productId=' + $(".img_productId_hide").val() + '&image=' + rightUrls,
                        success: function (data) {
                            if (data == "1") {
                                $.get("${basePath}/queryImageListByProductId.htm?productId=" + $(".img_productId_hide").val(), function (data) {
                                    var imageListHtml = "";
