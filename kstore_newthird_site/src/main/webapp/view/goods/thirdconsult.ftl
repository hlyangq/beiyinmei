...
<div class="wp">
    ...
    <div class="app-container">
        <ol class="breadcrumb">
            <li>您所在的位置</li>
            <li>商品管理</li>
            <li class="active" style="color: #07d;">咨询列表</a></li>
        </ol>
        ...
        <div class="app-content">
            ...
            <div class="search-block">
                <form action="querybyconsultthird.html" class="searchThirdConsultList" method="post">
                    <div class="filter-groups">
                        ...
                        <div class="search-operation">
                            <button class="btn btn-primary btn-sm" type="submit">查询<i
...
<script>
    ...
    function submitReplyForm(customerNickname, commentId) {
        ...
        if (commentContent != '') {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $(".reply_form").find("p").first().before('<p>' + format(new Date().getTime(), "yyyy-MM-dd HH:mm:ss") + '回复 <em class="text-info">' + customerNickname + '</em> ：' + commentContent + '</p>');
                    $("#commentContent").val("");
                }
            });
        }
    ...
    function delConsult() {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location.href = "initconsultthird.html";
            }
        });
    }
