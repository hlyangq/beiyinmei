                ...
                <div class="app-content step_wp step_01">
                    ...
                    <div>
                        <div class="cfg-content">
                            ...
                            <input type="hidden" id="cateGrade" value="${map.thirdCate.catGrade}"/>
                            <input type="hidden" id="cateId" value="${map.thirdCate.catId}"/>
                            <input type="hidden" id="cateParentId" value="${map.thirdCate.catParentId}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls col-xs-7">
                                            <input type="text" name="goodsName"
                                                   ...
                                                   class="up_text goods_name form-control" maxlength="120" minlength="3"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="controls col-xs-7">
                                            <input class="up_text goods_sub_title form-control" maxlength="240"
                                        ...
                                        <div class="controls col-xs-7">
                                            ...
                                            <#list  map.brandList as brand>
                                                <option value="${brand.brandId }"
                                                        <#if  map.goodsModifiedVo.goodsBrand.brandId==brand.brandId >selected="selected" </#if>>${brand.brandName }</option>
                                            </#list>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="controls col-xs-7" style="margin-top:5px;">
                                            <#list openSpec.specValList as specVal>
                                                <#if specVal.imgUrl??><img width='20px' height='20px'
                                                                           src="${specVal.imgUrl!''}"/></#if>${specVal.specValueRemark!''}
                                            </#list>
                                        </div>
                                    </div>
                                </#list>
                        ...
                        <#if map.isThirdAuditUsed??>
                            <#if map.isThirdAuditUsed == '1'>
                                <#if map.goodsModifiedVo.auditStatus == '0' || map.goodsModifiedVo.auditStatus == '3' || map.goodsModifiedVo.auditStatus == '2'>
                                    <a class="btn btn-primary sa_goods" href="javascript:;"><span id="auditstr">去审核</span></a>
                                </#if>
                            <#else>
