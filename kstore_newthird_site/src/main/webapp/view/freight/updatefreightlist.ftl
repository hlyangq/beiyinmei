                                                    ...
                                                    <div id="detail-express${company.shoreExpId}"  class="delivery-info-bar" data-delivery="express" style=" display: none;
                                                        ...
                                                        <table class="table" data-maxindex="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>首费（元）</th>
                                                                <th class="methodslist">续<#if freightTemplate.freightMethods="1">重（g）</#if><#if freightTemplate.freightMethods="0">件（个）</#if></th>
                                                                <th>续费（元）</th>
                                                                <th>操作</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody id="add_tr">
                                                                ...
                                                                <#list freightTemplate.freightExpressList as expresslist>
                                                                    <#if company.shoreExpId==expresslist.logComId>
                                                                        ...
                                                                        <tr data-group="n${expressAll_index+1 }"  data-group-value="${expressAll_index+1 }" data-code="${company.expCompany }" class="omg">
                                                                            <td>
