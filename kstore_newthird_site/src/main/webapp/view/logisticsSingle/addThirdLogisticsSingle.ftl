...
<script type="text/javascript">
    ...
    function addform(){
        ...
        {
            $('.warning').html("注：没有物流公司!请添加物流公司")
            return ;
        }

        var lheight=$("#logisticsSingleHeight").val();
        ...
        var lwidth=$("#logisticsSingleWidth").val();
        if (lwidth == "" || lwidth == "0" || isNaN(lwidth) || lwidth<=0)
        {
