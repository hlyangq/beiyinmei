                                ...
                                <#if pb.list?size gt 0>
                                    <#list pb.list as orderGoods>
                                        ...
                                        <tr>
                                            ...
                                            <td><#if orderGoods.goodsBackPrice??>${orderGoods.goodsBackPrice?string("0.00") }</#if></td>
                                            <td><#if orderGoods.caRateProduc??>${orderGoods.caRateProduc?string("0.00") }</#if></td>
