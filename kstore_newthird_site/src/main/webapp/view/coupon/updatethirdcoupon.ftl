                ...
                <div class="form-container">
                    ...
                    <form class="form-horizontal" action="addcouponthird.htm" id="addForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-xs-8">
                                	<div class="radio radio-primary">
                                		<label class="choose-label"><input name="couponGetType" type="radio" value="0" <#if (coupon.couponGetType)?? && coupon.couponGetType=='0'>checked="checked"</#if>/>领取券（通过链接或者劵码领取优惠券）</label>
