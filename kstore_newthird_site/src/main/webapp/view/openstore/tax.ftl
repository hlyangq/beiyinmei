                ...
                <div class="create-wrapper">
                    <form method="post" id="aptitude_from" action="${basePath}/savetax.htm" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-wp">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls col-xs-7">
                                        <input type="text" class="form-control" name="bankId" value="${(info.bankId)!''}"/>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-wp">
                                <div class="form-group">
                                    <label class="control-label col-xs-3">税务登记证号：</label>
                                    <div class="controls col-xs-7">
                                        <input type="text" class="form-control" maxlength="30" name="bussTaxRegistId" id="bussTaxRegistId" value="${(info.bussTaxRegistId)!''}"/>
                                        <p id=bussTaxRegistIdTip  ><i></i><i class=border></i><s></s><span></span></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-xs-3">纳税人识别号：</label>
                                    <div class="controls col-xs-7">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">税务登记证电子版：</label>
                                    <div class="controls col-xs-7" style="margin-top:7px;">
