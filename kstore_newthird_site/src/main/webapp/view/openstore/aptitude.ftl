                ...
                <div class="create-wrapper">
                    <form method="post" id="aptitude_from" action="${basePath}/saveaptitude.htm" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-item">
                            ...
                            <div class="form-wp">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls col-xs-7">
                                        <input type="text" class="form-control" maxlength="18" name="bussId" id="bussId" value="${(info.bussId)!''}"/>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-wp">
                                <div class="form-group">
                                    <label class="control-label col-xs-3">组织机构代码：</label>
                                    <div class="controls col-xs-7">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-xs-3">组织机构代码证电子版：</label>
                                    <div class="controls col-xs-7" style="margin-top:7px;">
