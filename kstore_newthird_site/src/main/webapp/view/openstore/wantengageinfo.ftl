                    ...
                    <form method="post" id="want_from" action="${basePath}/savewantengage.htm" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-wp">
                                <div class="form-group">
                                    ...
                                    <div class="controls col-xs-7">
                                        <input type="text" class="form-control" name="storeName" onblur="checkStoreName()" id="storeName" value="${(info.storeName)!''}" onkeydown='if(event.keyCode==13) return false;'/>
                        ...
                        <div class="form-item">
                            <div class="form-wp">
                                ...
                                <input type="hidden" value="" name="bdids" id="bdids" class="hasbd" />
            ...
            $.ajaxMutiUpload({
                ...
                success: function(data){
                    if(data!=null){
                        ...
                        html+='<td><img src="'+data.applyBrandPic+'" width="150" height="50"/> <input type="hidden" class="hide_appbid" value="'+data.applyBrandId+'" name="appId"/></td>';
