                        ...
                        <form action="querythirdoutstock.html" class="searchThirdOrderList" method="post">
                            ...
                            <div class="filter-groups">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="form-control" type="text" name="shippingPerson" value="<#if map.order.shippingPerson??>${map.order.shippingPerson}</#if>"/>
                                    </div>
                                </div>
                                <div class="control-group lg-group">
                            ...
                            <tr class="content-row">
                                    ...
                                    <#if order.orderGoodsList??>
                                        <#list order.orderGoodsList as maps>
                                            <#if maps.goodsProductVo??>
                                                <a href="${map.bset}/item/${maps.goodsProductVo.goodsInfoId!''}.html" title="${maps.goodsProductVo.goodsInfoName!'' }"><img src="${maps.goodsProductVo.goodsInfoImgId!'' }" alt="商品1" width="60" height="60"/></a>
                                            </#if>
                                        </#list>
                                    </#if>
                                </td>
                                ...
                                <td>
                                    ...
                                    <#elseif order.orderStatus=="13">
                                        <span class="label label-primary">拒绝退款</span>
                                    </#if>
                                </td>
                                <td>
