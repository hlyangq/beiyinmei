                ...
                <tbody class="tbody">
                    <#list map.orderGoodsInfos as orderGoodsInfos>
                        <tr>
                            ...
                            <td>
                                <#if orderGoodsInfos.goodsProductVo.goodsInfoName?length gt 30>
                                ${orderGoodsInfos.goodsProductVo.goodsInfoName?substring(0,30)}...
                                <#else>
                                ${orderGoodsInfos.goodsProductVo.goodsInfoName}
                                </#if>
                            </td>
                            <td>
                                 <#list orderGoodsInfos.goodsProductVo.specVo as specVo>

                                 ${specVo.spec.specName}: <#if specVo.specValueRemark??>${specVo.specValueRemark}<#else>${specVo.goodsSpecDetail.specDetailName}</#if><br/>
                                 </#list>
                            </td>
    ...
    <div class="modal fade" id="JHout_success" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" onclick="$('#JHout_success').modal('hide');"  data-dismiss="modal">确定</button>
                </div>
            </div>
        </div>
    </div>
