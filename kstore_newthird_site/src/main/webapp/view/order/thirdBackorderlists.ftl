                    ...
                    <div class="search-block">
                        <form action="queryThirdBackOrderList.html" class="searchThirdOrderList" method="post">
                            ...
                            <div class="filter-groups">
                                ...
                                <div class="control-group lg-group">
                                    <label class="control-label">退单价格：</label>
                                    <div class="controls">
                                            ...
                                            <tr class="content-row">
                                                ...
                                                <#--遍历该订单下面的所有商品的信息-->
                                                    ...
                                                    <#if order.orderGoodslistVo?? && order.orderGoodslistVo?size gt 0>
                                                        <#list order.orderGoodslistVo as backGoods>
                                                            <a href="${map.bset}/item/${backGoods.goodsInfoId!''}.html" title="${backGoods.goodsInfoName!''}"><img src="${backGoods.goodsInfoImgId!'' }" alt="${backGoods.goodsInfoName!''}" width="60" height="60"/></a>
                                                        </#list>
                                                    <#else>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <#else>
                                                            <button type="button" class="btn btn-primary btn-sm" style="width: 112px;" onclick="javascript:window.location.href='toexambackorder.html?backOrderId=<#if order.backOrderId??>${order.backOrderId}</#if>'">查看详情</button>
                                                        </#if>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="updateBackOrderStatus.htm" method="post" class="up_third_backOrder_money">
                ...
                <input type="hidden" id="backFlag2"  name="sign" value="" />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="updateBackOrderStatus.htm" method="post" class="up_queren_order_sta">
                ...
                <input type="hidden" id="confirmBackCheck" name="backCheck" value=""/>
                <input type="hidden" id="backFlag3"  name="sign" value="" />
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">操作提示</h4>
                </div>
                <div class="modal-body">
                    <div class="form-item">
                        ...
                        <label style="line-height: 35px; width: 50px; text-align: right"><input type="radio" name="_backLogStatus" class="backLogStatus" value="4" onchange="showPrice(0)" checked>是</label>
                        <label style="line-height: 35px; width: 50px; text-align: right"><input type="radio" name="_backLogStatus" class="backLogStatus" value="7" onchange="showPrice(1)">否</label>
                    </div>
                    <div class="form-item" id="priceDiv">
                        <label class="control-label">退款金额：</label>
                        <label style="line-height: 35px; width: 100px; text-align: right;"><input type="text" name="backPrice" id="backmoney" class="form-control money" value="" style="text-align: center"></label>
                        <label class="swValueTips ui-state-highlight"></label>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="updateBackOrderStatus.htm" method="post" class="up_third_order_sta">
                ...
                <input type="hidden" id="backFlag1"  name="sign" value="" />
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">操作提示</h4>
                </div>
