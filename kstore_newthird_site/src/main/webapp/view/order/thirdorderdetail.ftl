                            ...
                            <div class="od-cont">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><em>发票类型：</em>
                                        <#if order.invoiceType?? && order.invoiceType=='1'>
                                            普通发票
                                        <#elseif order.invoiceType?? && order.invoiceType=='2'>
                                            增值税发票
                                        <#else>
                                            无
                                        </#if>
                                    ...
                                    <tr>
                                        ...
                                        <td><em>运费：</em><#if order.expressPrice??>${order.expressPrice?string("0.00")}</#if></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><em>订单总价：</em><#if order.orderPrice??>${order.orderPrice?string("0.00")}</#if></td>
