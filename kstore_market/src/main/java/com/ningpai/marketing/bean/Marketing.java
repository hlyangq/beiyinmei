...
public class Marketing {
     ...
     * 满赠集合
     */
    private List<FullbuyPresentMarketing> fullbuyPresentMarketings;
    ...
    public List<FullbuyPresentMarketing> getFullbuyPresentMarketings() {
        return fullbuyPresentMarketings;
    }

    public void setFullbuyPresentMarketings(List<FullbuyPresentMarketing> fullbuyPresentMarketings) {
        this.fullbuyPresentMarketings = fullbuyPresentMarketings;
    }
