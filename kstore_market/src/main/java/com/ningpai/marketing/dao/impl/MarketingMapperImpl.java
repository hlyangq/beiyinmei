...
public class MarketingMapperImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public List<Marketing> queryByCreatimeMarketingsWithPanicBuying(Map<String, Object> map) {
        return this.selectList( "com.ningpai.marketing.dao.MarketingMapper.queryByCreatimeMarketingsWithPanicBuying",
                map);
    }
