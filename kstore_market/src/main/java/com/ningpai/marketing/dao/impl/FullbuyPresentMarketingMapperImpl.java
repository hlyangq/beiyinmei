...
public class FullbuyPresentMarketingMapperImpl extends BasicSqlSupport
    ...
    @Override
    public int insertSelective(FullbuyPresentMarketing fullbuyPresentMarketing) {
        return this
                .insert("com.ningpai.marketing.dao.FullbuyPresentMarketingMapper.insertSelective",
                        fullbuyPresentMarketing);
    }
    @Override
    public Long selectLastId() {
        return this
                .selectOne("com.ningpai.marketing.dao.FullbuyPresentMarketingMapper.selectLastId");
    }
