...
public class GoodsCategory {
    ...
    public Date getCatCreateTime() {
        return   this.catCreateTime == null ? null : (Date) catCreateTime.clone();
    }
    /**
     * 设置创建时间
     * */
    ...
    public Date getCatModifiedTime() {
        return this.catModifiedTime == null? null: (Date) catModifiedTime.clone();
    }
    /**
     * 设置修改时间
     * */
    ...
    public Date getCatDelTime() {
        return this.catDelTime == null ? null : (Date) catDelTime.clone();
    }
    /**
     * 设置删除时间
     * */
