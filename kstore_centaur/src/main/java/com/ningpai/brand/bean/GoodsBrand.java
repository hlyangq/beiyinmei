...
public class GoodsBrand {
    ...
    public Date getBrandCreateTime() {
        return this.brandCreateTime == null ? null : (Date) brandCreateTime.clone();
    }
    /**
     * 设置创建时间
     * */
    ...
    public Date getBrandModifiedTime() {
        return this.brandModifiedTime == null ? null : (Date) brandModifiedTime.clone();
    }
    /**
     * 设置修改时间
     * */
    ...
    public Date getBrandDelTime() {
        return this.brandDelTime == null ? null:(Date) brandDelTime.clone();
    }
    /**
     * 设置删除时间
     * */
