...
public class Report implements Serializable {
    ...
    public BigDecimal getShouldBuckle() {
        return shouldBuckle == null ? new BigDecimal(0.00) : shouldBuckle.setScale(3, BigDecimal.ROUND_HALF_UP);
    }
    ...
    public BigDecimal getCateRatebackPrice() {
        return cateRatebackPrice;
    }

    public void setCateRatebackPrice(BigDecimal cateRatebackPrice) {
        this.cateRatebackPrice = cateRatebackPrice;
    }
}
