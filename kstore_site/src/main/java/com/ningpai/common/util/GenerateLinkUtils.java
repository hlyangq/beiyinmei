...
public class GenerateLinkUtils {
    ...
    public static String forgetgenerateActivateLink(HttpServletRequest request, CustomerAllInfo user) throws Exception {
        ...
        // byte[] outputData = DESCoder.decrypt(inputData, key1);
        // String outputStr = new String(outputData);
        final String checkCode = generatePwdCheckcode(user);
        url = url.substring(0, url.lastIndexOf("/")) + "/validate/newvalidbindemail.html?" + CHECK_CODE + "=" + checkCode + "&d=" + DESCoder.encryptBASE64(inputData1)
        ...
        request.getSession().setAttribute("email_checkCode", checkCode);
        return url;
    }
