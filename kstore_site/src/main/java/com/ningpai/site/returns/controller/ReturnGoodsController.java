...
//        }
        ...
        for (int i = 0; i < backorder.getGoods().size(); i++) {
            ...
            OrderGoods orderGoods = orderService.queryOrderGoodsByIds(backorder.getOrderId(),goodsProductDetailViewVo.getGoodsInfoId(),backorder.getGoods().get(i).getGoodsCouponPrice());
//            if(backorder.getGoods().get(i).getGoodsCouponPrice() == null){
