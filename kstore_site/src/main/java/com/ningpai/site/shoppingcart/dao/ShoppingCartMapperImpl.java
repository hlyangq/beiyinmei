...
public class ShoppingCartMapperImpl extends BasicSqlSupport implements
    ...
    @Override
    public List<Object> selectById(Long shoppingCartId) {
        return super.selectList("com.ningpai.web.dao.ShoppingCartMapper.selectByPrimaryKey",shoppingCartId);
    }
    ...
    @Override
    public int changeShoppingCartMarketId(ShoppingCart sc) {
        return this
                .update("com.ningpai.web.dao.ShoppingCartMapper.changeShoppingCartMarketId",
                        sc);
    }
     ...
     */
    @Override
    public int queryShoppingCateCount(Long id, Long customerId) {
        Map<String, Object> map = new HashMap<>();
        map.put("id", id);
        map.put("customerId", customerId);
        return this.selectOne(
                "com.ningpai.web.dao.ShoppingCartMapper.queryShoppingCateCount",
                map);
    }
}
