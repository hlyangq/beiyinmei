...
public class GoodsCateVo {
     ...
     * 判断当前栏目是否是第三极栏目
     *
     * @return 如果是第三极栏目 返回true  否则返回false
     */
    public boolean isThreeCate() {
        if(catGrade != null){
            return catGrade == 3;
        }else{
            return false;
     ...
     * 判断当前栏目是否是第二级栏目
     *
     * @return 如果是第二极栏目 返回true  否则返回false
     */
    public boolean isTwoCate() {
        if(catGrade != null){
            return catGrade == 2;
        }else{
            return false;
     ...
     * 判断当前栏目是否是第一级栏目
     *
     * @return 如果是第一极栏目 返回true  否则返回false
     */
    public boolean isRootCate() {
        if(catGrade != null){
            return catGrade == 1;
        }else{
            return false;
