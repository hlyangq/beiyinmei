        ...
        <div class="section-01">
            <div class="f-brand">
                ...
                <div class="news-center right">
                    <div class="title"><a href="information/list/" class="right" target="_blank">更多<i></i></a>新闻中心</div>
                    <div class="pet-news">
                    	<#if pageAdvs?? && (pageAdvs?size>1)>
                        <a href="${pageAdvs[1].adverHref}" target="_blank"><img src="${pageAdvs[1].adverPath}" width="441" height="150"></a>
                        </#if>
                        <ul>
                    ...
                    <div class="proBox">
                        ...
                        <div class="pLinks">
                            <#list floors.indexCateList as cates>
                                <#if cates_index < 6>
                                    <a href="list/${cates.id?c}-${floors.goodsCatId?c}.html">
                                        <#if cates.name?length lte 4>
                                            ${cates.name}
                                        <#else>
                                            ${cates.name[0..3]}
                                        </#if>
