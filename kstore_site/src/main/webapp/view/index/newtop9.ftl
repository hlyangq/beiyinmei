            ...
            <div class="slot slot_headerTop01">
                ...
                <ul class="siteNav">
                    ...
                    <li class="nav_item navCenter">
                        <a href="${basePath}/customer/index.html" target="_blank">我的${topmap.systembase.bsetName}<i class="iconfont">&#xe607;</i></a>
                    ...
                    <li class="nav_item"><a href="${basePath}/help/92" target="_blank">帮助中心</a></li>
                </ul>
            </div>
