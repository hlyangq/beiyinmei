...
<div class="section_headerTop">
            <div class="slot slot_headerTop01">
                <ul class="left">
                    ...
                    <li>
                    <a href="${basePath}/customer/index.html" class="site_register" target="_blank">会员中心</a>
                    </li>
                ...
                <div class="cartfd">
                    ...
                    <div class="cartit">
                        <span><s></s><a href="${basePath}/myshoppingcart.html" target="_blank">购物车</a><strong class="cartNum">0</strong>件</span>
                    </div>
            ...
            <div id="logo_n" style="height: 45px;"><a href="${topmap.systembase.bsetAddress}" style="padding-top: 0px; height: 45px"><img src="${topmap.systembase.bsetLogo}" style="height: auto;"/></a></div>
