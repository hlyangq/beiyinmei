...
<div class="slide_wp clearfix">
        	<div class="slide_box fl">
            	<div id="slides">
            		<#list avc.list as listc>
                	<a href="${listc.adverHref}"><img alt="" src="${listc.adverPath}" /></a>
                    </#list>
                </div><!--/slides-->
                	...
                	<div class="jscroll_wp">
                    	<div class="jscroll_box">
                            <ul class="jscroll_list clearfix">
                            	<#list avs.list as lists>
                                <li><a href="${lists.adverHref}"><img alt="" src="${lists.adverPath}" width="250" height="160" /></a></li>
                                </#list>
                            </ul><!--/jscroll_list-->
                        </div><!--/jscroll_box-->
                    </div><!--/jscroll_wp-->
            ...
            <div class="live_wp fr">
                ...
                <div class="hao_post">
                	<h4><span style="text-decoration:line-through;">好享公告&gt;&gt;</span></h4>
                    <div class="post_cont">
                    	<ul class="h_post">
                        	<li><a href="javascript:;"><span style="text-decoration:line-through;">好享购物2013销售排行榜！</span></a></li>
                            <li><a href="javascript:;"><span style="text-decoration:line-through;">好享购物2013销售排行榜！</span></a></li>
                            <li><a href="javascript:;"><span style="text-decoration:line-through;">好享购物2013销售排行榜！</span></a></li>
                            <li><a href="javascript:;"><span style="text-decoration:line-through;">好享购物2013销售排行榜！</span></a></li>
                        </ul><!--/h_post-->
        ...
        <div class="mt20 clearfix">
        	<div class="deals fl pr">
            	<div class="deals_tit clearfix">
                	<h4 class="fl"><span style="text-decoration:line-through;">限时特惠</span></h4>
                </div><!--/deals_tit-->
        ...
        <#if floors.abs[0]?exists>
       		<a href="${floors.abs[0].path}"><img alt="${floors.abs[0].path}" src="${floors.abs[0].abUrl}" /></a>
       	</#if>
        	...
        	<div class="flr_left fl">
                ...
                <div class="hot_recommend mt5">
                    ...
                    <ul class="brand_list clearfix mt10">
                    	<#list floors.abs as ab>
                    	<#if (ab_index > 3 )>
                    	<#if (ab_index < 7 )>
                        	<li><a href="${ab.path}"><img alt="" src="${ab.abUrl}" width="70" height="50" /></a></li>
                    	</#if>                   	
                    	</#if>
                    	</#list>
                    </ul><!--/brand_list-->
                    <p class="into_brand mt10 tr"><a href="list/${floors.storeyCateId}-${floors.storeyCateId}.html">进入&gt;&gt;</a></p>
                </div><!--/hot_recommend-->
            </div><!--/flr_left-->
            <div class="flr_right fl">
            	<div class="rmd_title clearfix">
                    ...
                    <div class="tit_cont fl clearfix">
                    	<a class="more_rmd fr" href="list/${floors.storeyCateId}-${floors.storeyCateId}.html">进入更多推荐&gt;</a>
                    	<ul class="rmd_list clearfix fr">
                    		<#list floors.indexCateList as cates>  
                        		<li><a href="list/${cates.id}-${floors.storeyCateId}.html">${cates.name}</a></li>
                         	</#list>
                        </ul><!--/rmd_list-->                 
                    </div><!--/tit_cont-->
                </div><!--/rmd_title-->
                <div class="recommend_cont pr">
                	<div class="rmd_slides">
                    	...
                    	<#if (ab_index > 0 )>
                    	<#if (ab_index < 4 )>
                    	<a href="${ab.path}"><img alt="${ab.path}" src="${ab.abUrl}" width="470" height="228" /></a>
                    	</#if>                   	
                    	</#if>
                    	</#list>
                    ...
                    <ul class="rmd_pros clearfix">
                    	<#list floors.indexGoodList as goods>
                    	<li>
                            ...
                            <a class="pros_name" href="item/${goods.id}.html"><#if goods.name?length gt 12>${goods.name?substring(0,12)}<#else>${goods.name}</#if></a>
                            <p class="clearfix">
                            	<span class="pros_code fl">编号：${goods.number}</span>
