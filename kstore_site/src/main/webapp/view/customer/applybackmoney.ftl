                                        ...
                                        <tbody>
                                            ...
                                            <#list backorder.goods as border>
                                                ...
                                                <#--<#if  staCheck??&staCheck='0'> <td><input type="checkbox" name="backGoodsId" id="${border.goodsId!''}_back" onclick="getprice(${border.goodsId},${border.goodsInfoSumPrice},${border.goodsNum})" value="${border.goodsId!''}" class="back_goods_id"/></td></#if>-->
                                                    ...
                                                    <#if  isUseCoupon??&isUseCoupon='0'> <td><input type="checkbox" name="backGoodsId" id="${border.goodsId!''}_back" onclick="getprice(${border.goodsId},${border.orderGoodsId},${border.goodsInfoSumPrice?string('0.00')},<#if border.returnMoney??>${border.returnMoney?string('0.00')}<#else>0.00</#if>,${border.goodsNum},this)" value="${border.goodsId!''}" class="back_goods_id"/></td></#if>
                                                    <td class="tl">
