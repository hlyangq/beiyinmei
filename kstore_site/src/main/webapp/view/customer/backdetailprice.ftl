                                ...
                                <#if backOrderLog.backLogStatus??>
                                    <#if backOrderLog.backLogStatus == '7' || backOrderLog.backLogStatus == '8'>
                                        <p>
                                            ...
                                            <i></i>
                                            <span class="track-cont">退款${(bOrder.backPrice)?string("0.00")}元成功 (操作：平台)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 7><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,6)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '6'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">收货失败 (操作：平台)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 13><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,12)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '5'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">确认收货(操作：平台)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 13><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,12)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '4'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">填写快递信息(操作：顾客)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 13><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,12)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '3'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">申请审核不通过(操作：平台)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 13><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,12)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '2'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">申请审核通过(操作：平台)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 13><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,12)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                    <#if backOrderLog.backLogStatus == '1'>
                                        <p class="latest-track">
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">申请退款审核(操作：顾客)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 13><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,12)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                    ...
                                    <#if backOrderLog.backLogStatus == '9'>
                                        <p>
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">拒绝退款(操作：平台)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 10><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,12)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                                </#if>
                            </#list>
