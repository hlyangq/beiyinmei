            ...
            <div class="new_order_list">
                ...
                <div class="tagMenu order-menu">
                    <ul class="ods_tabs menu clearfix">
                        <li<#if (!type?? || type == '5') > class="current" </#if> data-val="5"><a href="${basePath}/customer/myorder.html" >所有订单</a></li>
                        ...
                        <li <#if (type?? && type == '6')>class="current"</#if> data-val="6"><a href="javascript:;" >退货订单</a></li>
                    </ul>
                </div>
                            ...
                            <#list pb.list as order>
                                ...
                                <tr class="order-bd">
                                    ...
                                    <td>
                                        ...
                                        <#if (order.orderStatus=="1" && isBackOrder==1) >
...
<div class="member-dialog dia4" style="display: none">
    <div class="member-dialog-body">
        ...
        <div class="tc">
            <div class="que-delete clearfix">
                <img style="margin-right: 0" src="${basePath}/images/images_l6.png"/>
                <div class="fl tl">
