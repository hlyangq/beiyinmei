            ...
            <div class="mod-main clearfix">
                <div class="mod-main-left fl clearfix">
                    ...
                    <div class="mod-sugar fl ml10">
                        ...
                        <p class="mt10" style="background-color: #CCCCCC; background-image: none; width: 80px">${customer.pointLevelName!''}</p>
                ...
                <div class="mod-main-rig">
                    ...
                    <dl class="clearfix">
                        <dt>预存款：</dt>
                        <dd><a class="active" target="_blank" href="${basePath}/deposit/mydeposit.htm"><b>￥${(deposit.preDeposit+deposit.freezePreDeposit)?string('0.00')}</b>元</a></dd>
                    </dl>
                    <dl class="clearfix">
                        <dt>我的积分：</dt>
                            ...
                            <div  class="new-proscoll">
                                <ul>
                                        <#list browses as browse>
                                                <li>
                                                    <a target="_blank" title="${(browse.goods.goodsName)!''}" href="${basePath}/item/${browse.goodsId}.html"><img src="<#if browse.goods.goodsImageList??><#list browse.goods.goodsImageList as image><#if image_index==0>${image.imageBigName!''}</#if></#list></#if>" alt="${(browse.goods.goodsName)!''}" title="${(browse.goods.goodsName)!''}" width="215" height="215" >
