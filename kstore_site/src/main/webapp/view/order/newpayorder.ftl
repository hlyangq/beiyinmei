                        ...
                        <div class="container clearfix pt20 pb10">
                            ...
                            <div class="payment-box">
                                                ...
                                                <#if (pay.isOpen=='1'&& (pay.payType=='1'||pay.payType=='2'||pay.payType=='4'||pay.payType=='5'))>
                                                    <li title="${pay.payName}">
                                                        ...
                                                        <a paytype="${pay.payType}"
                                                           ...
                                                           href="javascript:;">
                                                            <#if pay.payType=='5'>
                                                                <img src="${basePath}/images/payment3.jpg" alt="${pay.payName}">
                                                                <!-- 余额支付 -->
                                ...
                                <div class="box for-pre-deposit" style="display: none;">
                                    <div class="alert-box">
                                        <p class="fl">可用存款：￥<span id="predeposit"></span></p>
                                    ...
                                    <div id="payInput">
                                        ...
                                        <div class="charge-form">
                                            <input type="password" style="display: none;"><!-- 防止密码自动填充 -->
                                            <!--
                                            ...
                                            <a href="${basePath}/deposit/changepaypasswordview.htm" target="_blank">忘记密码？</a>
                                        </div>
                                        <p class="error"></p>
                                    </div>
    ...
    function payTypeClick(dom, payId, payType) {
        ...
        if(payType=='5'){ //余额款支付的时候
            ...
            defer.done(function(res){
                //console.log(res);
                // {retcode: "-1", orderprice: 2049.5, predeposit: 2950.52, msg: "密码错误3数，余额支付被锁定，24小时候再试"}
                if(res.retcode=='-1'){
                    $("#payInput").hide();
