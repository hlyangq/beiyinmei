                                ...
                                <div class="shopping-list clearfix mt20">
                                                                            ...
                                                                            <div class="goods-item clearfix">
                                                                                ...
                                                                                <div class="goods-msg">
                                                                                    ...
                                                                                    <#--计算各个商家的费用-->
                                                                                        ...
                                                                                        <span class="ml20">x<#if cars.goodsNum??>${cars.goodsNum}

                                                                                        </#if></span>
													<span class="ml20 p-inventory stock_${cars.goodsDetailBean.productVo.goodsInfoId!'0'}" skuid="335154"
                                        ...
                                        <#--没有参与促销-->
                                            <#if cartMap.shoplist??&&cartMap.shoplist?size!=0>
                                                <#list cartMap.shoplist as cars>
                                                                        ...
                                                                        <div class="goods-item clearfix">
                                                                            ...
                                                                            <div class="goods-msg">
                                                                                ...
                                                                                <#--计算各个商家的费用-->
                                                                                    ...
                                                                                    <span class="pv_smprice price_${pro.productDetail.goodsInfoId}"
                                                                                          style="color:red">¥ ${pro.productDetail.goodsInfoPreferPrice?number*cars.goodsNum?number*pn?number} </span>
                                                                                    <span class="ml20">${pn?number}件/套 x<#if cars.goodsNum??>${cars.goodsNum}</#if></span>
													<span class="ml20 p-inventory stock_${pro.productDetail.goodsInfoId}" skuid="335154"
													...
													<span class="ml20 p-inventory stock_${cars.goodsDetailBean.productVo.goodsInfoId}" skuid="335154"
                                    ...
                                    <div class="dis-modes">
                                        ...
                                        <div class="mode-item mode-tab pr">
                                            ...
                                            <h4 class="pt20">配送方式：<#--（<a class="ftx-05 alink" href="#">对应商品</a>）--></h4>
                                                ...
                                                <ul class=" clearfix">
                                                    ...
                                                    <#if third.thirdId==0>
                                                        <li class="mode-tab-item item-selected fretype"
                                                            ...
                                                            <b></b>
														<span id="jdShip-span-tip"  class="m-txt">
                                                          <i class="qmark-icon qmark-tip ziti" data-tips="上门自提只支持商城自营商品在线付款"></i>
                                                            上门自提
                                                        </li>
                                                    </#if>
                            ...
                            <div class="invoice-item invoice-item-selected" style="cursor:pointer">
                                ...
                                <div id="invoice-1" style="cursor:pointer">
                                    <span class="hide"><input type="hidden" value="4"></span>
										...
										<input type="text" style="cursor:pointer" class="itxt " data-r="个人" value="个人" readonly="true"><b></b>
										</span>
                                </div>
                            </div>
...
<div class="jd-dialog tip_dia dia17">
    <input type="hidden" id="addressflag">
    <div class="dia_tit clearfix">
        <h4 class="fl">提示</h4>
        <a class="dia_close fr" href="javascript:void(0)" onclick="cls()"></a>
    ...
    <div class="dia_tip">
        <div class="dia_intro no_tc pt30 pl30">
            <img class="vm" id="f_img" alt="" src="${basePath}/images/mod_war.png"/>
            <span id="con_00">收货地址上限:10个！</span>
        </div>
        <div class="dia_ops mt20 tc">
            <a class="go_pay" id="go_pay_00" href="javascript:cls();" style='margin:auto'>确定</a>
        </div>
