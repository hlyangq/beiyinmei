				...
				<#list orderlist as order >
                    <li <#if order_index==0>class="hover"</#if>>
                        ...
                        <div class="small_good">
                            <p class="img"><a href="${basePath}/giftdetail/${order.temp1}.html" target="_blank" title="${order.giftName}"><img alt="" src="<#if (order?? && order.giftPicList?? && order.giftPicList?size>0) >${order.giftPicList[0].picLittle}</#if>" /></a></p>
