    ...
    <div class="container row">
        <div class="pull-right">
            <ul class="toplinks">
                ...
                <li>
                    <a href="javascript:;"  onclick="addToFavorite('${topmap.systembase.bsetName}');">加入收藏</a>
                </li>
            </ul>
        </div>
        <div class="pull-right">
            <div class="welcome">
                <span>您好<#if cust??>${cust.customerNickname!''}</#if>，欢迎来到${topmap.systembase.bsetName}</span>
