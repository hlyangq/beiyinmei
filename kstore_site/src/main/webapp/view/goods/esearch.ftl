...
<div class="container" >
    ...
    <div class="content clearfix mt10">
		...
		<#if map.brands??&&map.params??&&map.brands?size+map.params?size &gt;4>
            ...
            <div class="operation_bar mt10">
                ...
                <div class="goodsTip ml15">
                    ...
                    <label class="m_check mr20 <#if inMarketing??&&inMarketing='1'>checked</#if>"><input class="vm mr5 check_show_marketing" type="checkbox" />促销商品</label>
                </div><!--/goodsTip-->
            </div><!--/operation_bar-->
                        ...
                        <li class="goodsBox">
                            ...
                            <#--设置该商品的价格与库存-->
                                ...
                                <div class="clearfix">
									...
									<span class="<#if stock &gt;0><#else>no-goods</#if> fr">
			...
			<#if (map.pb.rows &gt; 0)>
                <div class="paging_area">
                    <div class="paging">
					<#if ((map.pb.pageNo-3)>0)>
						<#assign pageNo="${map.pb.pageNo-3}" />
					<#else>
            ...
            <#else>
                <center>没有搜索到商品，修改一下搜索条件说不定会有意外收获哦！</center>
                <center>大家正在搜：
        ...
        <div class="left_wp fl">
            ...
            <div class="left_box" style="margin-top:33px;">
                <h3>浏览过的商品</h3>
						...
						<#list browserProduct.browHist as product>
							<#if (product?? && product_index &lt; 4)>
                                <li>
                                    ...
                                    <#assign productPrice=product.goods.goodsPrice>
