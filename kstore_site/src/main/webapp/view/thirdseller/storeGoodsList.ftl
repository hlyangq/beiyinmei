...
<title>${(map.nowcate.catName)!''}列表页</title>
...
<style type="text/css">
    ...
    .pss_search button{ border:none; width:73px; font-size:14px; font-weight:bold; letter-spacing:4px; cursor:pointer; line-height:32px; height:32px; overflow:hidden; background:#dd2b2f; margin-left:10px; border-radius:3px; color:#fff;}</style>
</head>
