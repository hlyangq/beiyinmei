...
<#assign basePath=request.contextPath>
    <title>${map.storeInfo.storeName!''}-${topmap.systembase.bsetName}</title>
                ...
                <div class="shoplistlist">
					<#list floors.indexGoodsList as goods>
						<#if (goods_index>=0) && (goods_index<8)>
                            <li>
                                <#if goods.urlpic?ends_with("!160")>
                                    <a class="shopimgs" href="${basePath}/item/${goods.id}.html" target="_blank"><img src="${goods.urlpic?substring(0,goods.urlpic?last_index_of("!"))}" width="260" height="260" style="display: block;"/></a>
                                <#else>
