 ...
 * param:比较控件name属性
 */
jQuery.validator.addMethod("eq", function (value, element, value2) {
  var flag = true;
  if (value != "" && value2 != ""
  ...
  return flag;
}, jQuery.validator.format("必须等于{0}"));

/**
 * 大于
 * param:比较控件name属性
 */
jQuery.validator.addMethod("ne", function (value, element, value2) {
  var flag = true;
  if (value != "" && value2 != ""
    && !(parseFloat(value) != parseFloat(value2))) {
    flag = false;
  ...
  return flag;
}, jQuery.validator.format("必须不等于{0}"));

/**
 * 大于
 * param:比较控件name属性
 */
jQuery.validator.addMethod("gt", function (value, element, value2) {
  var flag = true;
  if (value != "" && value2 != ""
    && !(parseFloat(value) > parseFloat(value2))) {
    flag = false;
 ...
 * param:比较控件name属性
 */
jQuery.validator.addMethod("ge", function (value, element, value2) {
  var flag = true;
  if (value != "" && value2 != ""
    && !(parseFloat(value) >= parseFloat(value2))
  ) {
 ...
 * 小于
 */
jQuery.validator.addMethod("lt", function (value, element, value2) {
  var flag = true;
  if (value != "" && value2 != ""
    && !(parseFloat(value) < parseFloat(value2))) {
    flag = false;
 ...
 * 小于等于
 */
jQuery.validator.addMethod("le", function (value, element, value2) {
  var flag = true;
  if (value != "" && value2 != ""
    && !(parseFloat(value) <= parseFloat(value2))) {
    flag = false;
